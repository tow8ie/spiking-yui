...
_yuitest_coverline("build/app-transitions/app-transitions.js", 40);
function AppTransitions() {}

_yuitest_coverline("build/app-transitions/app-transitions.js", 42);
...
@since 3.5.0
**/
_yuitest_coverline("build/app-transitions/app-transitions.js", 76);
AppTransitions.FX = {
    fade: {
        viewIn : 'app:fadeIn',
        viewOut: 'app:fadeOut'
...
_yuitest_coverline("build/app-transitions/app-transitions.js", 93);
AppTransitions.prototype = {
    ...
    **/
    _setTransitions: function (transitions) {
        _yuitest_coverfunc("build/app-transitions/app-transitions.js", "_setTransitions", 222);
_yuitest_coverline("build/app-transitions/app-transitions.js", 223);
...
if (transitions && transitions === true) {
            _yuitest_coverline("build/app-transitions/app-transitions.js", 226);
return Y.merge(defTransitions);
        }

        _yuitest_coverline("build/app-transitions/app-transitions.js", 229);
return transitions;
    }
};
...
_yuitest_coverline("build/app-transitions/app-transitions.js", 235);
Y.Base.mix(Y.App, [AppTransitions]);

_yuitest_coverline("build/app-transitions/app-transitions.js", 237);
Y.mix(Y.App.CLASS_NAMES, {
    transitioning: Y.ClassNameManager.getClassName('app', 'transitioning')
});


}, '3.7.0pr1', {"requires": ["app-base"]});
