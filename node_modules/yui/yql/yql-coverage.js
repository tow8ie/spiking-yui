...
if (!this._jsonp) {
            _yuitest_coverline("build/yql/yql.js", 116);
...
*/
_yuitest_coverline("build/yql/yql.js", 151);
...
Y.YQL = function (sql, callback, params, opts) {
    _yuitest_coverfunc("build/yql/yql.js", "YQL", 164);
_yuitest_coverline("build/yql/yql.js", 165);
return new Y.YQLRequest(sql, callback, params, opts).send();
};


}, '3.7.0pr1', {"requires": ["jsonp", "jsonp-url"]});
