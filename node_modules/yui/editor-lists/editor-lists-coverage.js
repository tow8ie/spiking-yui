...
_yuitest_coverline("build/editor-lists/editor-lists.js", 13);
var EditorLists = function() {
        _yuitest_coverfunc("build/editor-lists/editor-lists.js", "EditorLists", 13);
_yuitest_coverline("build/editor-lists/editor-lists.js", 14);
EditorLists.superclass.constructor.apply(this, arguments);
    }, LI = 'li', OL = 'ol', UL = 'ul', HOST = 'host';

    _yuitest_coverline("build/editor-lists/editor-lists.js", 17);
Y.extend(EditorLists, Y.Base, {
        ...
        */
        _onNodeChange: function(e) {
            _yuitest_coverfunc("build/editor-lists/editor-lists.js", "_onNodeChange", 24);
_yuitest_coverline("build/editor-lists/editor-lists.js", 25);
var inst = this.get(HOST).getInstance(), sel, li, 
            newLi, newList, sTab, par, moved = false, tag, focusEnd = false;

            _yuitest_coverline("build/editor-lists/editor-lists.js", 28);
if (e.changedType === 'tab') {
                _yuitest_coverline("build/editor-lists/editor-lists.js", 29);
...
if (par.get('tagName').toLowerCase() === OL) {
                        _yuitest_coverline("build/editor-lists/editor-lists.js", 38);
tag = OL;
                    }
                    
                    _yuitest_coverline("build/editor-lists/editor-lists.js", 41);
if (!li.test(LI)) {
                        _yuitest_coverline("build/editor-lists/editor-lists.js", 42);
li = li.ancestor(LI);
                    }
                    _yuitest_coverline("build/editor-lists/editor-lists.js", 44);
if (sTab) {
                        _yuitest_coverline("build/editor-lists/editor-lists.js", 45);
if (li.ancestor(LI)) {
...
focusEnd = true;
                        ...
                        _yuitest_coverline("build/editor-lists/editor-lists.js", 52);
if (li.previous(LI)) {
                            _yuitest_coverline("build/editor-lists/editor-lists.js", 53);
...
moved = true;
                ...
                _yuitest_coverline("build/editor-lists/editor-lists.js", 60);
if (moved) {
                    _yuitest_coverline("build/editor-lists/editor-lists.js", 61);
if (!li.test(LI)) {
...
li.all(EditorLists.REMOVE).remove();
                    _yuitest_coverline("build/editor-lists/editor-lists.js", 65);
if (Y.UA.ie) {
                        _yuitest_coverline("build/editor-lists/editor-lists.js", 66);
li = li.append(EditorLists.NON).one(EditorLists.NON_SEL);
                    }
                    //Selection here..
                    _yuitest_coverline("build/editor-lists/editor-lists.js", 69);
(new inst.EditorSelection()).selectNode(li, true, focusEnd);
                }
            }
        },
        initializer: function() {
            _yuitest_coverfunc("build/editor-lists/editor-lists.js", "initializer", 73);
_yuitest_coverline("build/editor-lists/editor-lists.js", 74);
this.get(HOST).on('nodeChange', Y.bind(this._onNodeChange, this));
    ...
    _yuitest_coverline("build/editor-lists/editor-lists.js", 114);
Y.namespace('Plugin');
