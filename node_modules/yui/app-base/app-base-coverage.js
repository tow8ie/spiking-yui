...
options.render && view.render();
        } else {_yuitest_coverline("build/app-base/app-base.js", 425);
if (created) {
            _yuitest_coverline("build/app-base/app-base.js", 426);
view.render();
        }}

        _yuitest_coverline("build/app-base/app-base.js", 429);
return this._set('activeView', view, {options: options});
    ...
    **/
    _attachView: function (view, prepend) {
        _yuitest_coverfunc("build/app-base/app-base.js", "_attachView", 446);
_yuitest_coverline("build/app-base/app-base.js", 447);
if (!view) {
            _yuitest_coverline("build/app-base/app-base.js", 448);
return;
        }

        _yuitest_coverline("build/app-base/app-base.js", 451);
var viewInfo      = this.getViewInfo(view),
            viewContainer = this.get('viewContainer');

        _yuitest_coverline("build/app-base/app-base.js", 454);
view.addTarget(this);
        _yuitest_coverline("build/app-base/app-base.js", 455);
viewInfo && (viewInfo.instance = view);
        ...
        _yuitest_coverline("build/app-base/app-base.js", 464);
viewContainer[prepend ? 'prepend' : 'append'](view.get('container'));
    ...
    **/
    _destroyContainer: function () {
        _yuitest_coverfunc("build/app-base/app-base.js", "_destroyContainer", 475);
_yuitest_coverline("build/app-base/app-base.js", 476);
var CLASS_NAMES   = Y.App.CLASS_NAMES,
            container     = this.get('container'),
            viewContainer = this.get('viewContainer'),
            areSame       = container.compareTo(viewContainer);
        ...
        _yuitest_coverline("build/app-base/app-base.js", 482);
if (Y.one('body').compareTo(container)) {
            // Just clean-up our events listeners.
            _yuitest_coverline("build/app-base/app-base.js", 484);
this.detachEvents();

            // Clean-up `yui3-app` CSS class on the `container`.
            _yuitest_coverline("build/app-base/app-base.js", 487);
...
viewContainer && viewContainer.remove(true);
            ...
            _yuitest_coverline("build/app-base/app-base.js", 497);
return;
        }
...
viewContainer && viewContainer.remove(true);
        _yuitest_coverline("build/app-base/app-base.js", 502);
!areSame && container && container.remove(true);
    ...
    **/
    _detachView: function (view) {
        _yuitest_coverfunc("build/app-base/app-base.js", "_detachView", 516);
_yuitest_coverline("build/app-base/app-base.js", 517);
if (!view) {
            _yuitest_coverline("build/app-base/app-base.js", 518);
return;
        }

        _yuitest_coverline("build/app-base/app-base.js", 521);
var viewInfo = this.getViewInfo(view) || {};

        _yuitest_coverline("build/app-base/app-base.js", 523);
if (viewInfo.preserve) {
            _yuitest_coverline("build/app-base/app-base.js", 524);
view.remove();
...
delete this._viewInfoMap[Y.stamp(view, true)];
            ...
            _yuitest_coverline("build/app-base/app-base.js", 538);
if (view === viewInfo.instance) {
                _yuitest_coverline("build/app-base/app-base.js", 539);
delete viewInfo.instance;
            }
        }

        _yuitest_coverline("build/app-base/app-base.js", 543);
view.removeTarget(this);
    ...
    **/
    _getViewContainer: function (value) {
        ...
        _yuitest_coverfunc("build/app-base/app-base.js", "_getViewContainer", 555);
_yuitest_coverline("build/app-base/app-base.js", 560);
if (!value && !this._viewContainer) {
            ...
            // recursion.
            _yuitest_coverline("build/app-base/app-base.js", 564);
value = this._viewContainer = this.create();
            _yuitest_coverline("build/app-base/app-base.js", 565);
this._set('viewContainer', value);
        }

        _yuitest_coverline("build/app-base/app-base.js", 568);
return value;
    },
    ...
    **/
    _initHtml5: function () {
        ...
        _yuitest_coverfunc("build/app-base/app-base.js", "_initHtml5", 586);
_yuitest_coverline("build/app-base/app-base.js", 589);
if (this.get('serverRouting') === false) {
            _yuitest_coverline("build/app-base/app-base.js", 590);
return false;
        } else {
            _yuitest_coverline("build/app-base/app-base.js", 592);
return Router.html5;
        }
    },
    ...
    **/
    _isChildView: function (view, parent) {
        _yuitest_coverfunc("build/app-base/app-base.js", "_isChildView", 611);
_yuitest_coverline("build/app-base/app-base.js", 612);
var viewInfo   = this.getViewInfo(view),
            parentInfo = this.getViewInfo(parent);

        _yuitest_coverline("build/app-base/app-base.js", 615);
if (viewInfo && parentInfo) {
            _yuitest_coverline("build/app-base/app-base.js", 616);
return this.getViewInfo(viewInfo.parent) === parentInfo;
        }

        _yuitest_coverline("build/app-base/app-base.js", 619);
return false;
    },
    ...
    **/
    _isParentView: function (view, child) {
        _yuitest_coverfunc("build/app-base/app-base.js", "_isParentView", 637);
_yuitest_coverline("build/app-base/app-base.js", 638);
var viewInfo  = this.getViewInfo(view),
            childInfo = this.getViewInfo(child);

        _yuitest_coverline("build/app-base/app-base.js", 641);
if (viewInfo && childInfo) {
            _yuitest_coverline("build/app-base/app-base.js", 642);
return this.getViewInfo(childInfo.parent) === viewInfo;
        }

        _yuitest_coverline("build/app-base/app-base.js", 645);
return false;
    },
    ...
    **/
    _navigate: function (url, options) {
        _yuitest_coverfunc("build/app-base/app-base.js", "_navigate", 667);
_yuitest_coverline("build/app-base/app-base.js", 668);
if (!this.get('serverRouting')) {
            ...
            _yuitest_coverline("build/app-base/app-base.js", 672);
options = Y.merge({force: true}, options);
        }

        _yuitest_coverline("build/app-base/app-base.js", 675);
return PjaxBase.prototype._navigate.call(this, url, options);
    ...
    **/
    _save: function (url, replace) {
        ...
        _yuitest_coverfunc("build/app-base/app-base.js", "_save", 700);
_yuitest_coverline("build/app-base/app-base.js", 703);
if (this.get('serverRouting') && !this.get('html5')) {
            // Perform same-origin check on the specified URL.
            _yuitest_coverline("build/app-base/app-base.js", 705);
if (!this._hasSameOrigin(url)) {
                _yuitest_coverline("build/app-base/app-base.js", 706);
Y.error('Security error: The new URL must be of the same origin as the current URL.');
                _yuitest_coverline("build/app-base/app-base.js", 707);
return this;
            }

            // Results in the URL's full path starting with '/'.
            _yuitest_coverline("build/app-base/app-base.js", 711);
url = this._joinURL(url || '');

            // Either replace the current history entry or create a new one
            // while navigating to the `url`.
            _yuitest_coverline("build/app-base/app-base.js", 715);
if (replace) {
                _yuitest_coverline("build/app-base/app-base.js", 716);
win && win.location.replace(url);
            } else {
                _yuitest_coverline("build/app-base/app-base.js", 718);
win && (win.location = url);
            }
...
return this;
        ...
        _yuitest_coverline("build/app-base/app-base.js", 724);
return Router.prototype._save.apply(this, arguments);
    ...
    **/
    _uiSetActiveView: function (newView, oldView, options) {
        _yuitest_coverfunc("build/app-base/app-base.js", "_uiSetActiveView", 763);
_yuitest_coverline("build/app-base/app-base.js", 764);
options || (options = {});

        _yuitest_coverline("build/app-base/app-base.js", 766);
var callback = options.callback,
        ...
        _yuitest_coverline("build/app-base/app-base.js", 773);
if (newView === oldView) {
            _yuitest_coverline("build/app-base/app-base.js", 774);
return callback && callback.call(this, newView);
        }

        _yuitest_coverline("build/app-base/app-base.js", 777);
this._attachView(newView, prepend);
        _yuitest_coverline("build/app-base/app-base.js", 778);
...
callback && callback.call(this, newView);
    ...
    **/
    _afterActiveViewChange: function (e) {
        _yuitest_coverfunc("build/app-base/app-base.js", "_afterActiveViewChange", 798);
_yuitest_coverline("build/app-base/app-base.js", 799);
this._uiSetActiveView(e.newVal, e.prevVal, e.options);
    ...
    ATTRS: {
        ...
        **/
        container: {
            valueFn: function () {
                _yuitest_coverfunc("build/app-base/app-base.js", "valueFn", 851);
_yuitest_coverline("build/app-base/app-base.js", 852);
return Y.one('body');
            }
        },
        ...
        **/
        serverRouting: {
            valueFn  : function () { _yuitest_coverfunc("build/app-base/app-base.js", "valueFn", 967);
_yuitest_coverline("build/app-base/app-base.js", 967);
...
// -- Namespace ----------------------------------------------------------------
_yuitest_coverline("build/app-base/app-base.js", 1018);
...
@since 3.5.0
**/
_yuitest_coverline("build/app-base/app-base.js", 1053);
...
@since 3.6.0
**/
_yuitest_coverline("build/app-base/app-base.js", 1064);
Y.App.CLASS_NAMES = {
...
}, '3.7.0pr1', {"requires": ["classnamemanager", "pjax-base", "router", "view"]});
