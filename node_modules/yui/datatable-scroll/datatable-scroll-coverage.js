...
@since 3.5.0
**/
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 53);
Y.DataTable.Scrollable = Scrollable = function () {};

_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 55);
Scrollable.ATTRS = {
    /**
...
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 78);
Y.mix(Scrollable.prototype, {
    ...
    **/
    scrollTo: function (id) {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "scrollTo", 95);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 96);
var target;

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 98);
...
target = this.getCell(id);
            } else {_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 101);
if (isNumber(id)) { 
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 102);
target = this.getRow(id);
            } else {_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 103);
if (isString(id)) {
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 104);
target = this._tbodyNode.one('#' + id);
            } else {_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 105);
if (id instanceof Y.Node &&
                    // TODO: ancestor(yScrollNode, xScrollNode)
                    id.ancestor('.yui3-datatable') === this.get('boundingBox')) {
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 108);
target = id;
            }}}}

            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 111);
target && target.scrollIntoView();
        }

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 114);
return this;
    },
    ...
    **/
    _addScrollbarPadding: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_addScrollbarPadding", 201);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 202);
var fixedHeader = this._yScrollHeader,
            headerClass = '.' + this.getClassName('header'),
            scrollbarWidth, rows, header, i, len;

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 206);
if (fixedHeader) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 207);
scrollbarWidth = Y.DOM.getScrollbarWidth() + 'px';
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 208);
...
header = rows.item(i).all(headerClass).pop();
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 212);
header.setStyle('paddingRight', scrollbarWidth);
    ...
    **/
    _afterScrollableChange: function (e) {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_afterScrollableChange", 226);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 227);
var scroller = this._xScrollNode;

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 229);
...
if (this._yScroll && !this._yScrollNode) {
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 231);
scroller.setStyle('paddingRight',
                    Y.DOM.getScrollbarWidth() + 'px');
            } else {_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 233);
if (!this._yScroll && this._yScrollNode) {
...
scroller.setStyle('paddingRight', '');
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 238);
this._syncScrollUI();
    },
    ...
    **/
    _afterScrollCaptionChange: function (e) {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_afterScrollCaptionChange", 250);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 251);
if (this._xScroll || this._yScroll) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 252);
this._syncScrollUI();
        }
    },
    ...
    **/
    _afterScrollColumnsChange: function (e) {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_afterScrollColumnsChange", 266);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 267);
if (this._xScroll || this._yScroll) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 268);
if (this._yScroll && this._yScrollHeader) {
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 269);
...
this._syncScrollUI();
    ...
    **/
    _afterScrollDataChange: function (e) {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_afterScrollDataChange", 285);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 286);
if (this._xScroll || this._yScroll) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 287);
this._syncScrollUI();
        }
    },
    ...
    **/
    _afterScrollHeightChange: function (e) {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_afterScrollHeightChange", 303);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 304);
if (this._yScroll) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 305);
this._syncScrollUI();
        }
    },
    ...
    */
    _afterScrollSort: function (e) {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_afterScrollSort", 317);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 318);
var headers, headerClass;

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 320);
if (this._yScroll && this._yScrollHeader) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 321);
headerClass = '.' + this.getClassName('header');
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 322);
...
this._yScrollHeader.all(headerClass).each(function (header, i) {
                _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "(anonymous 2)", 324);
...
header.set('className', headers.item(i).get('className'));
    ...
    **/
    _afterScrollWidthChange: function (e) {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_afterScrollWidthChange", 341);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 342);
if (this._xScroll || this._yScroll) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 343);
this._syncScrollUI();
        }
    },
    ...
    **/
    _bindScrollbar: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_bindScrollbar", 355);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 356);
...
if (scrollbar && scroller && !this._scrollbarEventHandle) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 360);
this._scrollbarEventHandle = new Y.Event.Handle([
    ...
    **/
    _bindScrollResize: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_bindScrollResize", 375);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 376);
...
this._scrollResizeHandle = Y.on('resize',
    ...
    **/
    _bindScrollUI: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_bindScrollUI", 395);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 396);
this.after({
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 408);
this.after(['dataChange', '*:add', '*:remove', '*:reset', '*:change'],
    ...
    **/
    _clearScrollLock: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_clearScrollLock", 420);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 421);
if (this._scrollLock) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 422);
this._scrollLock.cancel();
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 423);
delete this._scrollLock;
    ...
    **/
    _createScrollbar: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_createScrollbar", 436);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 437);
var scrollbar = this._scrollbarNode;

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 439);
if (!scrollbar) {
...
scrollbar = this._scrollbarNode = Y.Node.create(
            ...
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 447);
...
return scrollbar;
    ...
    **/
    _createScrollCaptionTable: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_createScrollCaptionTable", 462);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 463);
if (!this._captionTable) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 464);
this._captionTable = Y.Node.create(
                Y.Lang.sub(this._CAPTION_TABLE_TEMPLATE, {
                    className: this.getClassName('caption', 'table')
                }));

            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 469);
...
return this._captionTable;
    ...
    **/
    _createXScrollNode: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_createXScrollNode", 484);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 485);
if (!this._xScrollNode) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 486);
this._xScrollNode = Y.Node.create(
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 492);
return this._xScrollNode;
    ...
    **/
    _createYScrollHeader: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_createYScrollHeader", 504);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 505);
var fixedHeader = this._yScrollHeader;

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 507);
if (!fixedHeader) {
...
fixedHeader = this._yScrollHeader = Y.Node.create(
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 514);
return fixedHeader;
    },
    ...
    **/
    _createYScrollNode: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_createYScrollNode", 526);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 527);
var scrollerClass;

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 529);
...
this._yScrollContainer = Y.Node.create(
            ...
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 538);
this._yScrollNode = this._yScrollContainer
                .one('.' + scrollerClass);
        }

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 542);
return this._yScrollContainer;
    ...
    **/
    _disableScrolling: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_disableScrolling", 553);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 554);
this._removeScrollCaptionTable();
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 555);
this._disableXScrolling();
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 556);
...
this._uiSetWidth(this.get('width'));
    ...
    **/
    _disableXScrolling: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_disableXScrolling", 569);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 570);
this._removeXScrollNode();
    ...
    **/
    _disableYScrolling: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_disableYScrolling", 580);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 581);
this._removeYScrollHeader();
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 582);
this._removeYScrollNode();
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 583);
...
this._removeScrollbar();
    ...
    **/
    destructor: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "destructor", 594);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 595);
this._unbindScrollbar();
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 596);
this._unbindScrollResize();
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 597);
this._clearScrollLock();
    ...
    **/
    initializer: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "initializer", 609);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 610);
this._setScrollProperties();

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 612);
...
this.after('renderView', Y.bind('_syncScrollUI', this));
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 617);
Y.Do.after(this._bindScrollUI, this, 'bindUI');
    ...
    **/
    _removeScrollCaptionTable: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_removeScrollCaptionTable", 627);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 628);
if (this._captionTable) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 629);
if (this._captionNode) {
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 630);
...
this._captionTable.remove().destroy(true);
            ...
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 635);
delete this._captionTable;
    ...
    **/
    _removeXScrollNode: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_removeXScrollNode", 647);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 648);
var scroller = this._xScrollNode;

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 650);
if (scroller) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 651);
scroller.replace(scroller.get('childNodes').toFrag());
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 652);
...
delete this._xScrollNode;
    ...
    **/
    _removeYScrollContainer: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_removeYScrollContainer", 666);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 667);
var scroller = this._yScrollContainer;

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 669);
if (scroller) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 670);
scroller.replace(scroller.get('childNodes').toFrag());
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 671);
scroller.remove().destroy(true);
...
delete this._yScrollContainer;
    ...
    **/
    _removeYScrollHeader: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_removeYScrollHeader", 685);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 686);
if (this._yScrollHeader) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 687);
...
delete this._yScrollHeader;
    ...
    **/
    _removeYScrollNode: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_removeYScrollNode", 701);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 702);
var scroller = this._yScrollNode;

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 704);
if (scroller) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 705);
scroller.replace(scroller.get('childNodes').toFrag());
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 706);
scroller.remove().destroy(true);
...
delete this._yScrollNode;
    ...
    **/
    _removeScrollbar: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_removeScrollbar", 719);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 720);
if (this._scrollbarNode) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 721);
...
delete this._scrollbarNode;
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 725);
...
delete this._scrollbarEventHandle;
    ...
    **/
    _setScrollable: function (val) {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_setScrollable", 743);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 744);
if (val === true) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 745);
val = 'xy';
        }

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 748);
if (isString(val)) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 749);
val = val.toLowerCase();
        }
...
return (val === false || val === 'y' || val === 'x' || val === 'xy') ?
    ...
    **/
    _setScrollProperties: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_setScrollProperties", 766);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 767);
var scrollable = this.get('scrollable') || '',
            width      = this.get('width'),
            height     = this.get('height');

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 771);
this._xScroll = width  && scrollable.indexOf('x') > -1;
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 772);
this._yScroll = height && scrollable.indexOf('y') > -1;
    ...
    **/
    _syncScrollPosition: function (e) {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_syncScrollPosition", 784);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 785);
var scrollbar = this._scrollbarNode,
            scroller  = this._yScrollNode,
            source    = e.currentTarget,
            other;

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 790);
if (scrollbar && scroller) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 791);
if (this._scrollLock && this._scrollLock.source !== source) {
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 792);
return;
            }

            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 795);
this._clearScrollLock();
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 796);
this._scrollLock = Y.later(300, this, this._clearScrollLock);
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 797);
...
other.set('scrollTop', source.get('scrollTop'));
    ...
    **/
    _syncScrollCaptionUI: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_syncScrollCaptionUI", 813);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 814);
var caption      = this._captionNode,
            table        = this._tableNode,
            captionTable = this._captionTable,
            id;

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 819);
if (caption) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 820);
...
if (!caption.get('parentNode').compareTo(captionTable)) {
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 829);
...
id = Y.stamp(caption);
                    _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 833);
...
table.setAttribute('aria-describedby', id);
        ...
        } else {_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 838);
if (captionTable) {
...
this._removeScrollCaptionTable();
    ...
    **/
    _syncScrollColumnWidths: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_syncScrollColumnWidths", 851);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 852);
var widths = [];

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 854);
...
this._theadNode.all('.' + this.getClassName('header'))
                .each(function (header) {
                    _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "(anonymous 3)", 858);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 859);
widths.push(
            ...
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 878);
this._yScrollHeader.all('.' + this.getClassName('scroll', 'liner'))
                .each(function (liner, i) {
                    _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "(anonymous 4)", 879);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 880);
liner.setStyle('width', widths[i]);
    ...
    **/
    _syncScrollHeaders: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_syncScrollHeaders", 893);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 894);
var fixedHeader   = this._yScrollHeader,
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 900);
if (this._theadNode && fixedHeader) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 901);
fixedHeader.empty().appendChild(
                this._theadNode.cloneNode(true));

            // Prevent duplicate IDs and assign ARIA attributes to hide
            // from screen readers
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 906);
fixedHeader.all('[id]').removeAttribute('id');

            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 908);
fixedHeader.all('.' + headerClass).each(function (header, i) {
                _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "(anonymous 5)", 908);
...
var liner = Y.Node.create(Y.Lang.sub(linerTemplate, {
                ...
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 916);
liner.setStyle('padding',
                ...
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 922);
liner.appendChild(header.get('childNodes').toFrag());

                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 924);
...
this._syncScrollColumnWidths();
            ...
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 929);
this._addScrollbarPadding();
    ...
    **/
    _syncScrollUI: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_syncScrollUI", 942);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 943);
var x = this._xScroll,
            y = this._yScroll,
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 950);
...
if (x || y) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 954);
if ((this.get('width') || '').slice(-1) === '%') {
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 955);
...
this._syncScrollCaptionUI();
            ...
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 962);
this._disableScrolling();
        }

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 965);
if (this._yScrollHeader) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 966);
this._yScrollHeader.setStyle('display', 'none');
        }

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 969);
if (x) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 970);
if (!y) {
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 971);
this._disableYScrolling();
            }
...
if (y) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 978);
if (!x) {
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 979);
this._disableXScrolling();
            }
...
this._syncYScrollUI(x);
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 986);
if (scrollLeft && this._xScrollNode) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 987);
...
this._yScrollNode.set('scrollTop', scrollTop);
    ...
    **/
    _syncXScrollUI: function (xy) {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_syncXScrollUI", 1003);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1004);
var scroller     = this._xScrollNode,
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1012);
if (!scroller) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1013);
scroller = this._createXScrollNode();
            ...
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1017);
(yScroller || table).replace(scroller).appendTo(scroller);
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1022);
...
scroller.setStyle('width', '');
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1026);
this._uiSetDim('width', '');
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1027);
...
this._yScrollContainer.setStyle('width', '');
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1033);
if (Y.UA.ie && Y.UA.ie < 8) {
            ...
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1037);
table.setStyle('width', width);
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1038);
...
tableWidth = table.get('offsetWidth');
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1042);
...
this._uiSetDim('width', width);
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1048);
scroller.setStyle('width', (bbWidth - borderWidth) + 'px');
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1052);
if ((scroller.get('offsetWidth') - borderWidth) > tableWidth) {
            // Assumes the wrapped table doesn't have borders
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1054);
if (xy) {
...
table.setStyle('width', '100%');
    ...
    **/
    _syncYScrollUI: function (xy) {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_syncYScrollUI", 1073);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1074);
var yScroller    = this._yScrollContainer,
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1089);
if (captionTable && !xy) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1090);
captionTable.setStyle('width', width || '100%');
        }

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1093);
if (!yScroller) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1094);
yScroller = this._createYScrollNode();

            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1096);
yScrollNode = this._yScrollNode;

            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1098);
...
outerScroller = xy ? xScroller : yScroller;
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1103);
if (!xy) {
...
table.setStyle('width', '');
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1108);
if (xy) {
            // Account for the horizontal scrollbar in the overall height
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1110);
...
yScrollNode.setStyle('height',
        ...
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1120);
if (xy) {
...
if (captionTable && !xy) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1130);
captionTable.setStyle('width', yScroller.get('offsetWidth') + 'px');
        }

        // Allow headerless scrolling
        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1134);
if (thead && !fixedHeader) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1135);
...
yScroller.prepend(fixedHeader);
            ...
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1139);
this._syncScrollHeaders();
        }

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1142);
if (fixedHeader) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1143);
this._syncScrollColumnWidths();
...
fixedHeader.setStyle('display', '');
            ...
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1150);
if (!scrollbar) {
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1151);
scrollbar = this._createScrollbar();

                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1153);
this._bindScrollbar();

                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1155);
contentBox.prepend(scrollbar);
            }

            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1158);
this._uiSetScrollbarHeight();
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1159);
this._uiSetScrollbarPosition(outerScroller);
    ...
    **/
    _uiSetScrollable: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_uiSetScrollable", 1173);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1174);
this.get('boundingBox')
    ...
    **/
    _uiSetScrollbarHeight: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_uiSetScrollbarHeight", 1187);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1188);
var scrollbar   = this._scrollbarNode,
            scroller    = this._yScrollNode,
            fixedHeader = this._yScrollHeader;

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1192);
if (scrollbar && scroller && fixedHeader) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1193);
...
scrollbar.setStyle('height', 
    ...
    **/
    _uiSetScrollbarPosition: function (scroller) {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_uiSetScrollbarPosition", 1211);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1212);
var scrollbar     = this._scrollbarNode,
            fixedHeader   = this._yScrollHeader;

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1215);
if (scrollbar && scroller && fixedHeader) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1216);
scrollbar.setStyles({
    ...
    **/
    _uiSetYScrollWidth: function (width) {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_uiSetYScrollWidth", 1249);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1250);
var scroller = this._yScrollContainer,
            table    = this._tableNode,
            tableWidth, borderWidth, scrollerWidth, scrollbarWidth;

        _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1254);
if (scroller && table) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1255);
scrollbarWidth = Y.DOM.getScrollbarWidth();

            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1257);
if (width) {
                // Assumes no table border
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1259);
borderWidth = scroller.get('offsetWidth') -
                ...
                // configured width
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1265);
scroller.setStyle('width', width);
                ...
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1270);
...
table.setStyle('width', scrollerWidth + 'px');
                ...
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1275);
tableWidth = table.get('offsetWidth');
                ...
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1280);
scroller.setStyle('width',
                    (tableWidth + scrollbarWidth) + 'px');
            } else {
                // Allow the table to expand naturally
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1284);
table.setStyle('width', '');
                _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1285);
scroller.setStyle('width', '');
...
scroller.setStyle('width',
    ...
    **/
    _unbindScrollbar: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_unbindScrollbar", 1302);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1303);
if (this._scrollbarEventHandle) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1304);
this._scrollbarEventHandle.detach();
        }
    },
    ...
    **/
    _unbindScrollResize: function () {
        _yuitest_coverfunc("/build/datatable-scroll/datatable-scroll.js", "_unbindScrollResize", 1316);
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1317);
if (this._scrollResizeHandle) {
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1318);
this._scrollResizeHandle.detach();
            _yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1319);
...
_yuitest_coverline("/build/datatable-scroll/datatable-scroll.js", 1380);
Y.Base.mix(Y.DataTable, [Scrollable]);


}, '3.7.0pr1' ,{skinnable:true, requires:['datatable-base', 'dom-screen']});
