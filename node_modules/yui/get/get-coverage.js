...
_yuitest_coverage["build/get/get.js"].coveredLines = 255;
_yuitest_coverage["build/get/get.js"].coveredFunctions = 29;
...
return (this._env = {
    ...
    _getTransaction: function (urls, options) {
        _yuitest_coverfunc("build/get/get.js", "_getTransaction", 542);
_yuitest_coverline("build/get/get.js", 543);
var requests = [],
            i, len, req, url;

        _yuitest_coverline("build/get/get.js", 546);
...
options = Y.merge(this.options, options);
        ...
        _yuitest_coverline("build/get/get.js", 553);
options.attributes = Y.merge(this.options.attributes,
                options.attributes);

        _yuitest_coverline("build/get/get.js", 556);
for (i = 0, len = urls.length; i < len; ++i) {
            _yuitest_coverline("build/get/get.js", 557);
url = urls[i];
            _yuitest_coverline("build/get/get.js", 558);
req = {attributes: {}};
            ...
            _yuitest_coverline("build/get/get.js", 564);
if (typeof url === 'string') {
                _yuitest_coverline("build/get/get.js", 565);
req.url = url;
            } else {_yuitest_coverline("build/get/get.js", 566);
if (url.url) {
                // URL-specific options override both global defaults and
                // request-specific options.
                _yuitest_coverline("build/get/get.js", 569);
Y.mix(req, url, false, null, 0, true);
                _yuitest_coverline("build/get/get.js", 570);
url = url.url; // Make url a string so we can use it later.
            } else {
                _yuitest_coverline("build/get/get.js", 572);
continue;
            }}

            _yuitest_coverline("build/get/get.js", 575);
Y.mix(req, options, false, null, 0, true);

            // If we didn't get an explicit type for this URL either in the
            // request options or the URL-specific options, try to determine
            // one from the file extension.
            _yuitest_coverline("build/get/get.js", 580);
if (!req.type) {
                _yuitest_coverline("build/get/get.js", 581);
if (this.REGEX_CSS.test(url)) {
                    _yuitest_coverline("build/get/get.js", 582);
req.type = 'css';
                } else {
...
if (!this.REGEX_JS.test(url)) {
                    ...
                    _yuitest_coverline("build/get/get.js", 587);
req.type = 'js';
                }
            }
            ...
            _yuitest_coverline("build/get/get.js", 593);
...
req.attributes.id || (req.attributes.id = Y.guid());
            ...
            _yuitest_coverline("build/get/get.js", 600);
if (req.win) {
                _yuitest_coverline("build/get/get.js", 601);
req.doc = req.win.document;
            } else {
                _yuitest_coverline("build/get/get.js", 603);
req.win = req.doc.defaultView || req.doc.parentWindow;
            }

            _yuitest_coverline("build/get/get.js", 606);
if (req.charset) {
...
requests.push(req);
        ...
        _yuitest_coverline("build/get/get.js", 613);
return new Transaction(requests, options);
    },

    _load: function (type, urls, options, callback) {
        _yuitest_coverfunc("build/get/get.js", "_load", 616);
_yuitest_coverline("build/get/get.js", 617);
var transaction;

        // Allow callback as third param.
        _yuitest_coverline("build/get/get.js", 620);
if (typeof options === 'function') {
            _yuitest_coverline("build/get/get.js", 621);
callback = options;
            _yuitest_coverline("build/get/get.js", 622);
options  = {};
        }
...
options.type = type;
        ...
        _yuitest_coverline("build/get/get.js", 628);
if (!this._env) {
...
this._queue.push({
        ...
        _yuitest_coverline("build/get/get.js", 639);
this._next();

        _yuitest_coverline("build/get/get.js", 641);
return transaction;
    },

    _next: function () {
        _yuitest_coverfunc("build/get/get.js", "_next", 644);
_yuitest_coverline("build/get/get.js", 645);
var item;

        _yuitest_coverline("build/get/get.js", 647);
if (this._pending) {
            _yuitest_coverline("build/get/get.js", 648);
return;
        }
...
item = this._queue.shift();
        ...
        _yuitest_coverline("build/get/get.js", 653);
if (item) {
            _yuitest_coverline("build/get/get.js", 654);
this._pending = item;

            _yuitest_coverline("build/get/get.js", 656);
item.transaction.execute(function () {
                _yuitest_coverfunc("build/get/get.js", "(anonymous 2)", 656);
_yuitest_coverline("build/get/get.js", 657);
item.callback && item.callback.apply(this, arguments);

                _yuitest_coverline("build/get/get.js", 659);
Get._pending = null;
                _yuitest_coverline("build/get/get.js", 660);
Get._next();
            });
        }
    },
    ...
    _purge: function (nodes) {
        _yuitest_coverfunc("build/get/get.js", "_purge", 665);
_yuitest_coverline("build/get/get.js", 666);
var purgeNodes    = this._purgeNodes,
            isTransaction = nodes !== purgeNodes,
            index, node;

        _yuitest_coverline("build/get/get.js", 670);
while (node = nodes.pop()) { // assignment
            // Don't purge nodes that haven't finished loading (or errored out),
            // since this can hang the transaction.
            _yuitest_coverline("build/get/get.js", 673);
if (!node._yuiget_finished) {
                _yuitest_coverline("build/get/get.js", 674);
continue;
            }

            _yuitest_coverline("build/get/get.js", 677);
node.parentNode && node.parentNode.removeChild(node);
            ...
            _yuitest_coverline("build/get/get.js", 685);
if (isTransaction) {
                _yuitest_coverline("build/get/get.js", 686);
index = Y.Array.indexOf(purgeNodes, node);

                _yuitest_coverline("build/get/get.js", 688);
if (index > -1) {
                    _yuitest_coverline("build/get/get.js", 689);
...
@static
**/
_yuitest_coverline("build/get/get.js", 702);
Get.script = Get.js;
...
@since 3.5.0
**/
_yuitest_coverline("build/get/get.js", 715);
Get.Transaction = Transaction = function (requests, options) {
    _yuitest_coverfunc("build/get/get.js", "Transaction", 715);
_yuitest_coverline("build/get/get.js", 716);
var self = this;

    _yuitest_coverline("build/get/get.js", 718);
self.id       = Transaction._lastId += 1;
    _yuitest_coverline("build/get/get.js", 719);
...
@static
**/
_yuitest_coverline("build/get/get.js", 792);
Transaction._lastId = 0;

_yuitest_coverline("build/get/get.js", 794);
Transaction.prototype = {
    ...
    **/
    abort: function (msg) {
        _yuitest_coverfunc("build/get/get.js", "abort", 820);
_yuitest_coverline("build/get/get.js", 821);
this._pending    = null;
        _yuitest_coverline("build/get/get.js", 822);
this._pendingCSS = null;
        _yuitest_coverline("build/get/get.js", 823);
this._pollTimer  = clearTimeout(this._pollTimer);
        _yuitest_coverline("build/get/get.js", 824);
this._queue      = [];
        _yuitest_coverline("build/get/get.js", 825);
this._waiting    = 0;
...
this._finish();
    ...
    **/
    execute: function (callback) {
        _yuitest_coverfunc("build/get/get.js", "execute", 849);
_yuitest_coverline("build/get/get.js", 850);
var self     = this,
...
callback && callback(self.errors.length ? self.errors : null, self);
            _yuitest_coverline("build/get/get.js", 857);
return;
        } else {
            _yuitest_coverline("build/get/get.js", 859);
...
self._queue = queue = [];
        ...
        _yuitest_coverline("build/get/get.js", 869);
if (self.options.timeout) {
            _yuitest_coverline("build/get/get.js", 870);
self._timeout = setTimeout(function () {
                _yuitest_coverfunc("build/get/get.js", "(anonymous 3)", 870);
...
req = self.requests[i];
            ...
            _yuitest_coverline("build/get/get.js", 878);
...
self._next();
    ...
    **/
    purge: function () {
        _yuitest_coverfunc("build/get/get.js", "purge", 898);
_yuitest_coverline("build/get/get.js", 899);
Get._purge(this.nodes);
    },

    // -- Protected Methods ----------------------------------------------------
    _createNode: function (name, attrs, doc) {
        _yuitest_coverfunc("build/get/get.js", "_createNode", 903);
_yuitest_coverline("build/get/get.js", 904);
...
testEl = doc.createElement('div');
            _yuitest_coverline("build/get/get.js", 913);
...
node.setAttribute(CUSTOM_ATTRS[attr] || attr, attrs[attr]);
        ...
        _yuitest_coverline("build/get/get.js", 927);
return node;
    },

    _finish: function () {
        _yuitest_coverfunc("build/get/get.js", "_finish", 930);
...
var errors  = this.errors.length ? this.errors : null,
        ...
        _yuitest_coverline("build/get/get.js", 936);
if (this._state === 'done') {
            _yuitest_coverline("build/get/get.js", 937);
return;
        }

        _yuitest_coverline("build/get/get.js", 940);
this._state = 'done';

        _yuitest_coverline("build/get/get.js", 942);
for (i = 0, len = this._callbacks.length; i < len; ++i) {
            _yuitest_coverline("build/get/get.js", 943);
this._callbacks[i].call(thisObj, errors, this);
        }

        _yuitest_coverline("build/get/get.js", 946);
...
options.onFailure.call(thisObj, data);
        ...
        } else {_yuitest_coverline("build/get/get.js", 956);
...
options.onEnd.call(thisObj, data);
    ...
    _getEventData: function (req) {
        _yuitest_coverfunc("build/get/get.js", "_getEventData", 965);
_yuitest_coverline("build/get/get.js", 966);
if (req) {
...
return Y.merge(this, {
            ...
            _yuitest_coverline("build/get/get.js", 976);
return this;
        }
    },

    _getInsertBefore: function (req) {
        _yuitest_coverfunc("build/get/get.js", "_getInsertBefore", 980);
_yuitest_coverline("build/get/get.js", 981);
var doc = req.doc,
            el  = req.insertBefore,
            cache, cachedNode, docStamp;

        _yuitest_coverline("build/get/get.js", 985);
if (el) {
            _yuitest_coverline("build/get/get.js", 986);
return typeof el === 'string' ? doc.getElementById(el) : el;
        }

        _yuitest_coverline("build/get/get.js", 989);
cache    = Get._insertCache;
        _yuitest_coverline("build/get/get.js", 990);
...
return el;
        ...
        _yuitest_coverline("build/get/get.js", 999);
...
el = doc.head || doc.getElementsByTagName('head')[0];
        ...
        _yuitest_coverline("build/get/get.js", 1006);
if (el) {
...
return (cache[docStamp] = doc.getElementsByTagName('script')[0]);
    ...
    _insert: function (req) {
        _yuitest_coverfunc("build/get/get.js", "_insert", 1019);
_yuitest_coverline("build/get/get.js", 1020);
var env          = Get._env,
...
if (!node) {
            _yuitest_coverline("build/get/get.js", 1029);
if (isScript) {
                _yuitest_coverline("build/get/get.js", 1030);
nodeType = 'script';
            } else {_yuitest_coverline("build/get/get.js", 1031);
if (!env.cssLoad && ua.gecko) {
                _yuitest_coverline("build/get/get.js", 1032);
nodeType = 'style';
            } else {
                _yuitest_coverline("build/get/get.js", 1034);
nodeType = 'link';
            }}

            _yuitest_coverline("build/get/get.js", 1037);
...
function onError() {
            _yuitest_coverfunc("build/get/get.js", "onError", 1041);
...
function onLoad() {
            _yuitest_coverfunc("build/get/get.js", "onLoad", 1045);
_yuitest_coverline("build/get/get.js", 1046);
if (cssTimeout) {
                _yuitest_coverline("build/get/get.js", 1047);
clearTimeout(cssTimeout);
            }

            _yuitest_coverline("build/get/get.js", 1050);
self._progress(null, req);
        }


        // Deal with script asynchronicity.
        _yuitest_coverline("build/get/get.js", 1055);
if (isScript) {
...
node.async = true;
                ...
                _yuitest_coverline("build/get/get.js", 1064);
if (env.async) {
...
if (!env.preservesScriptOrder) {
                    _yuitest_coverline("build/get/get.js", 1076);
this._pending = req;
                }
            }
        } else {
...
if (!env.cssLoad && ua.gecko) {
                ...
                // technique.
                _yuitest_coverline("build/get/get.js", 1088);
node.innerHTML = (req.attributes.charset ?
                    '@charset "' + req.attributes.charset + '";' : '') +
                    '@import "' + req.url + '";';
            } else {
                _yuitest_coverline("build/get/get.js", 1092);
node.setAttribute('href', req.url);
            }
        }

        // Inject the node.
        _yuitest_coverline("build/get/get.js", 1097);
if (isScript && ua.ie && (ua.ie < 9 || (document.documentMode && document.documentMode < 9))) {
            // Script on IE < 9, and IE 9+ when in IE 8 or older modes, including quirks mode.
            _yuitest_coverline("build/get/get.js", 1099);
node.onreadystatechange = function () {
                _yuitest_coverfunc("build/get/get.js", "onreadystatechange", 1099);
_yuitest_coverline("build/get/get.js", 1100);
if (/loaded|complete/.test(node.readyState)) {
                    _yuitest_coverline("build/get/get.js", 1101);
node.onreadystatechange = null;
                    _yuitest_coverline("build/get/get.js", 1102);
onLoad();
                }
            };
        } else {_yuitest_coverline("build/get/get.js", 1105);
...
node.onload  = onLoad;
            ...
            _yuitest_coverline("build/get/get.js", 1116);
...
cssTimeout = setTimeout(onError, req.timeout || 3000);
        ...
        _yuitest_coverline("build/get/get.js", 1121);
this._waiting += 1;

        _yuitest_coverline("build/get/get.js", 1123);
this.nodes.push(node);
        _yuitest_coverline("build/get/get.js", 1124);
insertBefore.parentNode.insertBefore(node, insertBefore);
    },

    _next: function () {
        _yuitest_coverfunc("build/get/get.js", "_next", 1127);
_yuitest_coverline("build/get/get.js", 1128);
if (this._pending) {
            _yuitest_coverline("build/get/get.js", 1129);
return;
        }
        ...
        _yuitest_coverline("build/get/get.js", 1136);
if (this._queue.length) {
            _yuitest_coverline("build/get/get.js", 1137);
this._insert(this._queue.shift());
        } else {_yuitest_coverline("build/get/get.js", 1138);
if (!this._waiting) {
...
this._finish();
    ...
    _poll: function (newReq) {
        _yuitest_coverfunc("build/get/get.js", "_poll", 1143);
...
pendingCSS.push(newReq);
            ...
            _yuitest_coverline("build/get/get.js", 1153);
if (self._pollTimer) {
                // A poll timeout is already pending, so no need to create a
                // new one.
                _yuitest_coverline("build/get/get.js", 1156);
return;
            }
        }
...
for (i = 0; i < pendingCSS.length; ++i) {
            _yuitest_coverline("build/get/get.js", 1167);
req = pendingCSS[i];

            _yuitest_coverline("build/get/get.js", 1169);
if (isWebKit) {
...
while (--j >= 0) {
                    _yuitest_coverline("build/get/get.js", 1176);
if (sheets[j].href === nodeHref) {
                        _yuitest_coverline("build/get/get.js", 1177);
pendingCSS.splice(i, 1);
                        _yuitest_coverline("build/get/get.js", 1178);
i -= 1;
                        _yuitest_coverline("build/get/get.js", 1179);
self._progress(null, req);
                        _yuitest_coverline("build/get/get.js", 1180);
break;
                    }
                }
            } else {
...
self._progress(null, req);
        ...
        _yuitest_coverline("build/get/get.js", 1206);
if (pendingCSS.length) {
            _yuitest_coverline("build/get/get.js", 1207);
self._pollTimer = setTimeout(function () {
                _yuitest_coverfunc("build/get/get.js", "(anonymous 4)", 1207);
_yuitest_coverline("build/get/get.js", 1208);
self._poll.call(self);
    ...
    _progress: function (err, req) {
        _yuitest_coverfunc("build/get/get.js", "_progress", 1213);
_yuitest_coverline("build/get/get.js", 1214);
var options = this.options;

        _yuitest_coverline("build/get/get.js", 1216);
if (err) {
            _yuitest_coverline("build/get/get.js", 1217);
req.error = err;
...
this.errors.push({
        ...
        _yuitest_coverline("build/get/get.js", 1226);
...
options.onProgress.call(options.context || this,
        ...
        _yuitest_coverline("build/get/get.js", 1233);
if (req.autopurge) {
...
if (this._pending === req) {
            _yuitest_coverline("build/get/get.js", 1242);
this._pending = null;
        }

        _yuitest_coverline("build/get/get.js", 1245);
this._waiting -= 1;
        _yuitest_coverline("build/get/get.js", 1246);
this._next();
    }
};


}, '3.7.0pr1', {"requires": ["yui-base"]});
