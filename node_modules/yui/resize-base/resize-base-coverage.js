...
if (!wrapper.compareTo(node)) {
				...
				_yuitest_coverline("build/resize-base/resize-base.js", 1109);
node.sizeTo(
			...
			_yuitest_coverline("build/resize-base/resize-base.js", 1116);
if (Y.UA.webkit) {
...
node.setStyle(RESIZE, NONE);
		...
		_updateChangeHandleInfo: function(handle) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_updateChangeHandleInfo", 1129);
_yuitest_coverline("build/resize-base/resize-base.js", 1130);
var instance = this;

			_yuitest_coverline("build/resize-base/resize-base.js", 1132);
...
instance.changeWidthHandles = instance.REGEX_CHANGE_WIDTH.test(handle);
		...
		_updateInfo: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_updateInfo", 1144);
_yuitest_coverline("build/resize-base/resize-base.js", 1145);
var instance = this;

			_yuitest_coverline("build/resize-base/resize-base.js", 1147);
instance.info = instance._getInfo(instance.get(WRAPPER), event);
		...
		_updateSurroundingInfo: function() {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_updateSurroundingInfo", 1160);
_yuitest_coverline("build/resize-base/resize-base.js", 1161);
var instance = this,
				node = instance.get(NODE),
				wrapper = instance.get(WRAPPER),
			...
			_yuitest_coverline("build/resize-base/resize-base.js", 1167);
...
instance.wrapperSurrounding = wrapperSurrounding;
			...
			_yuitest_coverline("build/resize-base/resize-base.js", 1170);
...
instance.totalHSurrounding = (nodeSurrounding.totalHPadding + wrapperSurrounding.totalHBorder);
		...
		_setActiveHandlesUI: function(val) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_setActiveHandlesUI", 1181);
_yuitest_coverline("build/resize-base/resize-base.js", 1182);
var instance = this,
				activeHandleNode = instance.get(ACTIVE_HANDLE_NODE);

			_yuitest_coverline("build/resize-base/resize-base.js", 1185);
if (activeHandleNode) {
...
if (val) {
					...
					_yuitest_coverline("build/resize-base/resize-base.js", 1188);
instance.eachHandle(
						function(handleEl) {
							_yuitest_coverfunc("build/resize-base/resize-base.js", "(anonymous 11)", 1189);
_yuitest_coverline("build/resize-base/resize-base.js", 1190);
handleEl.removeClass(CSS_RESIZE_HANDLE_ACTIVE);
						}
					);

					_yuitest_coverline("build/resize-base/resize-base.js", 1194);
activeHandleNode.addClass(CSS_RESIZE_HANDLE_ACTIVE);
				}
				else {
					_yuitest_coverline("build/resize-base/resize-base.js", 1197);
activeHandleNode.removeClass(CSS_RESIZE_HANDLE_ACTIVE);
		...
		_setHandles: function(val) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_setHandles", 1209);
_yuitest_coverline("build/resize-base/resize-base.js", 1210);
var instance = this,
				handles = [];

			// handles attr accepts both array or string
			_yuitest_coverline("build/resize-base/resize-base.js", 1214);
if (isArray(val)) {
				_yuitest_coverline("build/resize-base/resize-base.js", 1215);
handles = val;
			}
			else {_yuitest_coverline("build/resize-base/resize-base.js", 1217);
if (isString(val)) {
				// if the handles attr passed in is an ALL string...
				_yuitest_coverline("build/resize-base/resize-base.js", 1219);
...
handles = instance.ALL_HANDLES;
				...
				// otherwise, split the string to extract the handles
					...
					_yuitest_coverline("build/resize-base/resize-base.js", 1224);
Y.each(
						val.split(COMMA),
						function(node, i) {
							_yuitest_coverfunc("build/resize-base/resize-base.js", "(anonymous 12)", 1226);
_yuitest_coverline("build/resize-base/resize-base.js", 1227);
var handle = trim(node);

							// if its a valid handle, add it to the handles output
							_yuitest_coverline("build/resize-base/resize-base.js", 1230);
...
handles.push(handle);
			...
			_yuitest_coverline("build/resize-base/resize-base.js", 1238);
return handles;
		},
		...
		_setHideHandlesUI: function(val) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_setHideHandlesUI", 1248);
_yuitest_coverline("build/resize-base/resize-base.js", 1249);
var instance = this,
				wrapper = instance.get(WRAPPER);

			_yuitest_coverline("build/resize-base/resize-base.js", 1252);
...
wrapper.addClass(CSS_RESIZE_HIDDEN_HANDLES);
					...
					_yuitest_coverline("build/resize-base/resize-base.js", 1257);
wrapper.removeClass(CSS_RESIZE_HIDDEN_HANDLES);
		...
		_setWrap: function(val) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_setWrap", 1269);
_yuitest_coverline("build/resize-base/resize-base.js", 1270);
var instance = this,
				node = instance.get(NODE),
			...
			_yuitest_coverline("build/resize-base/resize-base.js", 1276);
if (typeRegex.test(nodeName)) {
				_yuitest_coverline("build/resize-base/resize-base.js", 1277);
val = true;
			}

			_yuitest_coverline("build/resize-base/resize-base.js", 1280);
return val;
		},
		...
		_defMouseUpFn: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_defMouseUpFn", 1290);
_yuitest_coverline("build/resize-base/resize-base.js", 1291);
var instance = this;

			_yuitest_coverline("build/resize-base/resize-base.js", 1293);
instance.set(RESIZING, false);
		...
		_defResizeFn: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_defResizeFn", 1303);
_yuitest_coverline("build/resize-base/resize-base.js", 1304);
var instance = this;

			_yuitest_coverline("build/resize-base/resize-base.js", 1306);
instance._resize(event);
		...
		_resize: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_resize", 1316);
_yuitest_coverline("build/resize-base/resize-base.js", 1317);
var instance = this;

			_yuitest_coverline("build/resize-base/resize-base.js", 1319);
instance._handleResizeAlignEvent(event.dragEvent);

			// _syncUI of the wrapper, not using proxy
			_yuitest_coverline("build/resize-base/resize-base.js", 1322);
instance._syncUI();
		},
		...
		_defResizeAlignFn: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_defResizeAlignFn", 1332);
_yuitest_coverline("build/resize-base/resize-base.js", 1333);
var instance = this;

			_yuitest_coverline("build/resize-base/resize-base.js", 1335);
instance._resizeAlign(event);
		...
		_resizeAlign: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_resizeAlign", 1345);
_yuitest_coverline("build/resize-base/resize-base.js", 1346);
var instance = this,
				info,
				defMinHeight,
				defMinWidth;

			_yuitest_coverline("build/resize-base/resize-base.js", 1351);
instance.lastInfo = instance.info;

			// update the instance.info values
			_yuitest_coverline("build/resize-base/resize-base.js", 1354);
instance._updateInfo(event);

			_yuitest_coverline("build/resize-base/resize-base.js", 1356);
info = instance.info;

			// basic resize calculations
			_yuitest_coverline("build/resize-base/resize-base.js", 1359);
instance._calcResize();

			// if Y.Plugin.ResizeConstrained is not plugged, check for min dimension
			_yuitest_coverline("build/resize-base/resize-base.js", 1362);
if (!instance.con) {
...
defMinWidth = (instance.get(DEF_MIN_WIDTH) + instance.totalHSurrounding);
				...
				_yuitest_coverline("build/resize-base/resize-base.js", 1366);
...
instance._checkSize(OFFSET_HEIGHT, defMinHeight);
				...
				_yuitest_coverline("build/resize-base/resize-base.js", 1370);
...
instance._checkSize(OFFSET_WIDTH, defMinWidth);
		...
		_defResizeEndFn: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_defResizeEndFn", 1383);
_yuitest_coverline("build/resize-base/resize-base.js", 1384);
var instance = this;

			_yuitest_coverline("build/resize-base/resize-base.js", 1386);
instance._resizeEnd(event);
		...
		_resizeEnd: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_resizeEnd", 1396);
_yuitest_coverline("build/resize-base/resize-base.js", 1397);
var instance = this,
				drag = event.dragEvent.target;

			// reseting actXY from drag when drag end
			_yuitest_coverline("build/resize-base/resize-base.js", 1401);
drag.actXY = [];

			// syncUI when resize end
			_yuitest_coverline("build/resize-base/resize-base.js", 1404);
instance._syncUI();

			_yuitest_coverline("build/resize-base/resize-base.js", 1406);
instance._setActiveHandlesUI(false);

			_yuitest_coverline("build/resize-base/resize-base.js", 1408);
...
instance.set(ACTIVE_HANDLE_NODE, null);
			...
			_yuitest_coverline("build/resize-base/resize-base.js", 1411);
instance.handle = null;
		...
		_defResizeStartFn: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_defResizeStartFn", 1421);
_yuitest_coverline("build/resize-base/resize-base.js", 1422);
var instance = this;

			_yuitest_coverline("build/resize-base/resize-base.js", 1424);
instance._resizeStart(event);
		...
		_resizeStart: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_resizeStart", 1434);
_yuitest_coverline("build/resize-base/resize-base.js", 1435);
var instance = this,
				wrapper = instance.get(WRAPPER);

			_yuitest_coverline("build/resize-base/resize-base.js", 1438);
instance.handle = instance.get(ACTIVE_HANDLE);

			_yuitest_coverline("build/resize-base/resize-base.js", 1440);
instance.set(RESIZING, true);

			_yuitest_coverline("build/resize-base/resize-base.js", 1442);
instance._updateSurroundingInfo();

			// create an originalInfo information for reference
			_yuitest_coverline("build/resize-base/resize-base.js", 1445);
instance.originalInfo = instance._getInfo(wrapper, event);

			_yuitest_coverline("build/resize-base/resize-base.js", 1447);
instance._updateInfo(event);
		},
		...
		_handleMouseUpEvent: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_handleMouseUpEvent", 1457);
_yuitest_coverline("build/resize-base/resize-base.js", 1458);
this.fire(EV_MOUSE_UP, { dragEvent: event, info: this.info });
		...
		_handleResizeEvent: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_handleResizeEvent", 1468);
_yuitest_coverline("build/resize-base/resize-base.js", 1469);
this.fire(EV_RESIZE, { dragEvent: event, info: this.info });
		...
		_handleResizeAlignEvent: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_handleResizeAlignEvent", 1479);
_yuitest_coverline("build/resize-base/resize-base.js", 1480);
this.fire(EV_RESIZE_ALIGN, { dragEvent: event, info: this.info });
		...
		_handleResizeEndEvent: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_handleResizeEndEvent", 1490);
_yuitest_coverline("build/resize-base/resize-base.js", 1491);
this.fire(EV_RESIZE_END, { dragEvent: event, info: this.info });
		...
		_handleResizeStartEvent: function(event) {
            _yuitest_coverfunc("build/resize-base/resize-base.js", "_handleResizeStartEvent", 1501);
_yuitest_coverline("build/resize-base/resize-base.js", 1502);
if (!this.get(ACTIVE_HANDLE)) {
                //This handles the "touch" case
			    _yuitest_coverline("build/resize-base/resize-base.js", 1504);
this._setHandleFromNode(event.target.get('node'));
            }
			_yuitest_coverline("build/resize-base/resize-base.js", 1506);
this.fire(EV_RESIZE_START, { dragEvent: event, info: this.info });
		...
		_onWrapperMouseEnter: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_onWrapperMouseEnter", 1516);
_yuitest_coverline("build/resize-base/resize-base.js", 1517);
var instance = this;

			_yuitest_coverline("build/resize-base/resize-base.js", 1519);
...
instance._setHideHandlesUI(false);
		...
		_onWrapperMouseLeave: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_onWrapperMouseLeave", 1531);
_yuitest_coverline("build/resize-base/resize-base.js", 1532);
var instance = this;

			_yuitest_coverline("build/resize-base/resize-base.js", 1534);
if (instance.get(AUTO_HIDE)) {
...
instance._setHideHandlesUI(true);
        ...
        _setHandleFromNode: function(node) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_setHandleFromNode", 1546);
_yuitest_coverline("build/resize-base/resize-base.js", 1547);
var instance = this,
				handle = instance._extractHandleName(node);

			_yuitest_coverline("build/resize-base/resize-base.js", 1550);
if (!instance.get(RESIZING)) {
...
instance.set(ACTIVE_HANDLE_NODE, node);
				...
				_yuitest_coverline("build/resize-base/resize-base.js", 1554);
...
instance._updateChangeHandleInfo(handle);
		...
		_onHandleMouseEnter: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_onHandleMouseEnter", 1566);
_yuitest_coverline("build/resize-base/resize-base.js", 1567);
this._setHandleFromNode(event.currentTarget);
		...
		_onHandleMouseLeave: function(event) {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_onHandleMouseLeave", 1577);
_yuitest_coverline("build/resize-base/resize-base.js", 1578);
var instance = this;

			_yuitest_coverline("build/resize-base/resize-base.js", 1580);
if (!instance.get(RESIZING)) {
...
instance._setActiveHandlesUI(false);
		...
		_valueHandlesWrapper: function() {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_valueHandlesWrapper", 1592);
_yuitest_coverline("build/resize-base/resize-base.js", 1593);
return Y.Node.create(this.HANDLES_WRAP_TEMPLATE);
		...
		_valueWrapper: function() {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "_valueWrapper", 1603);
_yuitest_coverline("build/resize-base/resize-base.js", 1604);
var instance = this,
				node = instance.get(NODE),
...
node.setStyles({
			...
			_yuitest_coverline("build/resize-base/resize-base.js", 1630);
return wrapper;
		}
	}
);

_yuitest_coverline("build/resize-base/resize-base.js", 1635);
Y.each(Y.Resize.prototype.ALL_HANDLES, function(handle, i) {
	// creating ATTRS with the handles elements
	_yuitest_coverfunc("build/resize-base/resize-base.js", "(anonymous 13)", 1635);
_yuitest_coverline("build/resize-base/resize-base.js", 1637);
Y.Resize.ATTRS[handleAttrName(handle)] = {
		setter: function() {
			_yuitest_coverfunc("build/resize-base/resize-base.js", "setter", 1638);
_yuitest_coverline("build/resize-base/resize-base.js", 1639);
...
}, '3.7.0pr1', {"requires": ["base", "widget", "substitute", "event", "oop", "dd-drag", "dd-delegate", "dd-drop"], "skinnable": true});
