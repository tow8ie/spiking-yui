...
return null;
             ...
             */
            callback: function(){
                _yuitest_coverfunc("build/test/test.js", "callback", 1747);
_yuitest_coverline("build/test/test.js", 1748);
var names   = arguments,
                    data    = this._context,
                    that    = this;
                    
                _yuitest_coverline("build/test/test.js", 1752);
return function(){
                    _yuitest_coverfunc("build/test/test.js", "(anonymous 9)", 1752);
_yuitest_coverline("build/test/test.js", 1753);
for (var i=0; i < arguments.length; i++){
                        _yuitest_coverline("build/test/test.js", 1754);
data[names[i]] = arguments[i];
                    }
                    _yuitest_coverline("build/test/test.js", 1756);
that._run();
                };
            },
             ...
             */
            resume : function (segment) {
                _yuitest_coverfunc("build/test/test.js", "resume", 1768);
_yuitest_coverline("build/test/test.js", 1769);
if (this._waiting){
                    _yuitest_coverline("build/test/test.js", 1770);
this._resumeTest(segment || function(){});
                } else {
                    _yuitest_coverline("build/test/test.js", 1772);
throw new Error("resume() called without wait().");
            ...
            run : function (options) {
                ...
                _yuitest_coverfunc("build/test/test.js", "run", 1786);
_yuitest_coverline("build/test/test.js", 1788);
options = options || {};
                
                //pointer to runner to avoid scope issues 
                _yuitest_coverline("build/test/test.js", 1791);
var runner  = YUITest.TestRunner,
                    oldMode = options.oldMode;
                
                
                //if there's only one suite on the masterSuite, move it up
                _yuitest_coverline("build/test/test.js", 1796);
...
this.masterSuite = this.masterSuite.items[0];
                ...
                _yuitest_coverline("build/test/test.js", 1801);
runner._groups = (options.groups instanceof Array) ? "," + options.groups.join(",") + "," : "";
                
                //initialize the runner
                _yuitest_coverline("build/test/test.js", 1804);
runner._buildTestTree();
                _yuitest_coverline("build/test/test.js", 1805);
runner._context = {};
                _yuitest_coverline("build/test/test.js", 1806);
runner._root._start = new Date();
                
                //fire the begin event
                _yuitest_coverline("build/test/test.js", 1809);
...
_yuitest_coverline("build/test/test.js", 1829);
YUITest.ArrayAssert = {
    ...
    _indexOf: function(haystack, needle){
        _yuitest_coverfunc("build/test/test.js", "_indexOf", 1844);
_yuitest_coverline("build/test/test.js", 1845);
if (haystack.indexOf){
            _yuitest_coverline("build/test/test.js", 1846);
return haystack.indexOf(needle);
        } else {
            _yuitest_coverline("build/test/test.js", 1848);
for (var i=0; i < haystack.length; i++){
                _yuitest_coverline("build/test/test.js", 1849);
if (haystack[i] === needle){
                    _yuitest_coverline("build/test/test.js", 1850);
return i;
                }
            }
...
return -1;
    ...
    _some: function(haystack, matcher){
        _yuitest_coverfunc("build/test/test.js", "_some", 1867);
_yuitest_coverline("build/test/test.js", 1868);
if (haystack.some){
            _yuitest_coverline("build/test/test.js", 1869);
return haystack.some(matcher);
        } else {
            _yuitest_coverline("build/test/test.js", 1871);
for (var i=0; i < haystack.length; i++){
                _yuitest_coverline("build/test/test.js", 1872);
if (matcher(haystack[i])){
                    _yuitest_coverline("build/test/test.js", 1873);
return true;
                }
            }
...
return false;
    ...
    contains : function (needle, haystack, 
        ...
        _yuitest_coverfunc("build/test/test.js", "contains", 1889);
_yuitest_coverline("build/test/test.js", 1892);
YUITest.Assert._increment();               

        _yuitest_coverline("build/test/test.js", 1894);
if (this._indexOf(haystack, needle) == -1){
            _yuitest_coverline("build/test/test.js", 1895);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value " + needle + " (" + (typeof needle) + ") not found in array [" + haystack + "]."));
    ...
    containsItems : function (needles, haystack, 
                           message) {
        _yuitest_coverfunc("build/test/test.js", "containsItems", 1909);
_yuitest_coverline("build/test/test.js", 1911);
YUITest.Assert._increment();               

        //begin checking values
        _yuitest_coverline("build/test/test.js", 1914);
for (var i=0; i < needles.length; i++){
            _yuitest_coverline("build/test/test.js", 1915);
if (this._indexOf(haystack, needles[i]) == -1){
                _yuitest_coverline("build/test/test.js", 1916);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value " + needles[i] + " (" + (typeof needles[i]) + ") not found in array [" + haystack + "]."));
    ...
    containsMatch : function (matcher, haystack, 
        ...
        _yuitest_coverfunc("build/test/test.js", "containsMatch", 1930);
_yuitest_coverline("build/test/test.js", 1933);
YUITest.Assert._increment();               
        //check for valid matcher
        _yuitest_coverline("build/test/test.js", 1935);
if (typeof matcher != "function"){
            _yuitest_coverline("build/test/test.js", 1936);
...
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "No match found in array [" + haystack + "]."));
    ...
    doesNotContain : function (needle, haystack, 
        ...
        _yuitest_coverfunc("build/test/test.js", "doesNotContain", 1954);
_yuitest_coverline("build/test/test.js", 1957);
YUITest.Assert._increment();               

        _yuitest_coverline("build/test/test.js", 1959);
if (this._indexOf(haystack, needle) > -1){
            _yuitest_coverline("build/test/test.js", 1960);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value found in array [" + haystack + "]."));
    ...
    doesNotContainItems : function (needles, haystack, 
        ...
        _yuitest_coverfunc("build/test/test.js", "doesNotContainItems", 1974);
_yuitest_coverline("build/test/test.js", 1977);
YUITest.Assert._increment();               

        _yuitest_coverline("build/test/test.js", 1979);
for (var i=0; i < needles.length; i++){
            _yuitest_coverline("build/test/test.js", 1980);
if (this._indexOf(haystack, needles[i]) > -1){
                _yuitest_coverline("build/test/test.js", 1981);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value found in array [" + haystack + "]."));
            }
        }
    ...
    doesNotContainMatch : function (matcher, haystack, 
        ...
        _yuitest_coverfunc("build/test/test.js", "doesNotContainMatch", 1996);
_yuitest_coverline("build/test/test.js", 1999);
YUITest.Assert._increment();     
      
        //check for valid matcher
        _yuitest_coverline("build/test/test.js", 2002);
if (typeof matcher != "function"){
            _yuitest_coverline("build/test/test.js", 2003);
throw new TypeError("ArrayAssert.doesNotContainMatch(): First argument must be a function.");
        }
        
        _yuitest_coverline("build/test/test.js", 2006);
if (this._some(haystack, matcher)){
            _yuitest_coverline("build/test/test.js", 2007);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value found in array [" + haystack + "]."));
        }
    },
    ...
    indexOf : function (needle, haystack, index, message) {
        ...
        _yuitest_coverfunc("build/test/test.js", "indexOf", 2021);
_yuitest_coverline("build/test/test.js", 2023);
YUITest.Assert._increment();     

        //try to find the value in the array
        _yuitest_coverline("build/test/test.js", 2026);
for (var i=0; i < haystack.length; i++){
            _yuitest_coverline("build/test/test.js", 2027);
if (haystack[i] === needle){
                _yuitest_coverline("build/test/test.js", 2028);
if (index != i){
...
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value exists at index " + i + " but should be at index " + index + "."));                    
                ...
                _yuitest_coverline("build/test/test.js", 2031);
return;
            }
        }
...
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value doesn't exist in array [" + haystack + "]."));
    ...
    itemsAreEqual : function (expected, actual, 
        ...
        _yuitest_coverfunc("build/test/test.js", "itemsAreEqual", 2050);
_yuitest_coverline("build/test/test.js", 2053);
YUITest.Assert._increment();     
        
        //first make sure they're array-like (this can probably be improved)
        _yuitest_coverline("build/test/test.js", 2056);
if (typeof expected != "object" || typeof actual != "object"){
            _yuitest_coverline("build/test/test.js", 2057);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value should be an array."));
        }
        
        //next check array length
        _yuitest_coverline("build/test/test.js", 2061);
...
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Array should have a length of " + expected.length + " but has a length of " + actual.length + "."));
        ...
        //begin checking values
        _yuitest_coverline("build/test/test.js", 2066);
...
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Values in position " + i + " are not equal."), expected[i], actual[i]);
    ...
    itemsAreEquivalent : function (expected, actual, 
        ...
        _yuitest_coverfunc("build/test/test.js", "itemsAreEquivalent", 2087);
_yuitest_coverline("build/test/test.js", 2090);
YUITest.Assert._increment();     

        //make sure the comparator is valid
        _yuitest_coverline("build/test/test.js", 2093);
if (typeof comparator != "function"){
            _yuitest_coverline("build/test/test.js", 2094);
throw new TypeError("ArrayAssert.itemsAreEquivalent(): Third argument must be a function.");
        }
        
        //first check array length
        _yuitest_coverline("build/test/test.js", 2098);
if (expected.length != actual.length){
...
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Array should have a length of " + expected.length + " but has a length of " + actual.length));
        ...
        //begin checking values
        _yuitest_coverline("build/test/test.js", 2103);
for (var i=0; i < expected.length; i++){
...
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Values in position " + i + " are not equivalent."), expected[i], actual[i]);
    ...
    isEmpty : function (actual, message) {        
        _yuitest_coverfunc("build/test/test.js", "isEmpty", 2117);
_yuitest_coverline("build/test/test.js", 2118);
YUITest.Assert._increment();     
        _yuitest_coverline("build/test/test.js", 2119);
if (actual.length > 0){
            _yuitest_coverline("build/test/test.js", 2120);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Array should be empty."));
    ...
    isNotEmpty : function (actual, message) {        
        _yuitest_coverfunc("build/test/test.js", "isNotEmpty", 2131);
_yuitest_coverline("build/test/test.js", 2132);
YUITest.Assert._increment();     
        _yuitest_coverline("build/test/test.js", 2133);
if (actual.length === 0){
            _yuitest_coverline("build/test/test.js", 2134);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Array should not be empty."));
    ...
    itemsAreSame : function (expected, actual, 
        ...
        _yuitest_coverfunc("build/test/test.js", "itemsAreSame", 2149);
_yuitest_coverline("build/test/test.js", 2152);
YUITest.Assert._increment();     

        //first check array length
        _yuitest_coverline("build/test/test.js", 2155);
if (expected.length != actual.length){
            _yuitest_coverline("build/test/test.js", 2156);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Array should have a length of " + expected.length + " but has a length of " + actual.length));
        }
                    
        //begin checking values
        _yuitest_coverline("build/test/test.js", 2160);
for (var i=0; i < expected.length; i++){
...
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Values in position " + i + " are not the same."), expected[i], actual[i]);
    ...
    lastIndexOf : function (needle, haystack, index, message) {
        ...
        //try to find the value in the array
        _yuitest_coverfunc("build/test/test.js", "lastIndexOf", 2178);
_yuitest_coverline("build/test/test.js", 2181);
for (var i=haystack.length; i >= 0; i--){
            _yuitest_coverline("build/test/test.js", 2182);
if (haystack[i] === needle){
                _yuitest_coverline("build/test/test.js", 2183);
if (index != i){
                    _yuitest_coverline("build/test/test.js", 2184);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value exists at index " + i + " but should be at index " + index + "."));                    
                }
                _yuitest_coverline("build/test/test.js", 2186);
return;
            }
        }
 ...
 * @static
 */
_yuitest_coverline("build/test/test.js", 2205);
YUITest.Assert = {
    ...
    _formatMessage : function (customMessage, defaultMessage) {
        _yuitest_coverfunc("build/test/test.js", "_formatMessage", 2229);
_yuitest_coverline("build/test/test.js", 2230);
if (typeof customMessage == "string" && customMessage.length > 0){
            _yuitest_coverline("build/test/test.js", 2231);
return customMessage.replace("{message}", defaultMessage);
        } else {
            _yuitest_coverline("build/test/test.js", 2233);
return defaultMessage;
     ...
     */
    _getCount: function(){
        _yuitest_coverfunc("build/test/test.js", "_getCount", 2243);
_yuitest_coverline("build/test/test.js", 2244);
return this._asserts;
     ...
     */
    _increment: function(){
        _yuitest_coverfunc("build/test/test.js", "_increment", 2253);
_yuitest_coverline("build/test/test.js", 2254);
this._asserts++;
    },
     ...
     */
    _reset: function(){
        _yuitest_coverfunc("build/test/test.js", "_reset", 2263);
_yuitest_coverline("build/test/test.js", 2264);
this._asserts = 0;
    },
     ...
     */
    fail : function (message) {
        _yuitest_coverfunc("build/test/test.js", "fail", 2277);
_yuitest_coverline("build/test/test.js", 2278);
throw new YUITest.AssertionError(YUITest.Assert._formatMessage(message, "Test force-failed."));
    ...
    pass : function (message) {
        _yuitest_coverfunc("build/test/test.js", "pass", 2286);
_yuitest_coverline("build/test/test.js", 2287);
YUITest.Assert._increment();
    },       
    ...
    areEqual : function (expected, actual, message) {
        _yuitest_coverfunc("build/test/test.js", "areEqual", 2303);
_yuitest_coverline("build/test/test.js", 2304);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2305);
if (expected != actual) {
            _yuitest_coverline("build/test/test.js", 2306);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Values should be equal."), expected, actual);
        }
    },
    ...
    areNotEqual : function (unexpected, actual, 
                         message) {
        _yuitest_coverfunc("build/test/test.js", "areNotEqual", 2319);
_yuitest_coverline("build/test/test.js", 2321);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2322);
if (unexpected == actual) {
            _yuitest_coverline("build/test/test.js", 2323);
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Values should not be equal."), unexpected);
    ...
    areNotSame : function (unexpected, actual, message) {
        _yuitest_coverfunc("build/test/test.js", "areNotSame", 2336);
_yuitest_coverline("build/test/test.js", 2337);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2338);
if (unexpected === actual) {
            _yuitest_coverline("build/test/test.js", 2339);
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Values should not be the same."), unexpected);
    ...
    areSame : function (expected, actual, message) {
        _yuitest_coverfunc("build/test/test.js", "areSame", 2352);
_yuitest_coverline("build/test/test.js", 2353);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2354);
if (expected !== actual) {
            _yuitest_coverline("build/test/test.js", 2355);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Values should be the same."), expected, actual);
        }
    },    
    ...
    isFalse : function (actual, message) {
        _yuitest_coverfunc("build/test/test.js", "isFalse", 2371);
_yuitest_coverline("build/test/test.js", 2372);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2373);
if (false !== actual) {
            _yuitest_coverline("build/test/test.js", 2374);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Value should be false."), false, actual);
    ...
    isTrue : function (actual, message) {
        _yuitest_coverfunc("build/test/test.js", "isTrue", 2386);
_yuitest_coverline("build/test/test.js", 2387);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2388);
if (true !== actual) {
            _yuitest_coverline("build/test/test.js", 2389);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Value should be true."), true, actual);
    ...
    isNaN : function (actual, message){
        _yuitest_coverfunc("build/test/test.js", "isNaN", 2405);
_yuitest_coverline("build/test/test.js", 2406);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2407);
if (!isNaN(actual)){
            _yuitest_coverline("build/test/test.js", 2408);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Value should be NaN."), NaN, actual);
    ...
    isNotNaN : function (actual, message){
        _yuitest_coverfunc("build/test/test.js", "isNotNaN", 2419);
_yuitest_coverline("build/test/test.js", 2420);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2421);
if (isNaN(actual)){
            _yuitest_coverline("build/test/test.js", 2422);
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Values should not be NaN."), NaN);
    ...
    isNotNull : function (actual, message) {
        _yuitest_coverfunc("build/test/test.js", "isNotNull", 2434);
_yuitest_coverline("build/test/test.js", 2435);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2436);
if (actual === null) {
            _yuitest_coverline("build/test/test.js", 2437);
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Values should not be null."), null);
    ...
    isNotUndefined : function (actual, message) {
        _yuitest_coverfunc("build/test/test.js", "isNotUndefined", 2449);
_yuitest_coverline("build/test/test.js", 2450);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2451);
if (typeof actual == "undefined") {
            _yuitest_coverline("build/test/test.js", 2452);
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Value should not be undefined."), undefined);
    ...
    isNull : function (actual, message) {
        _yuitest_coverfunc("build/test/test.js", "isNull", 2464);
_yuitest_coverline("build/test/test.js", 2465);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2466);
if (actual !== null) {
            _yuitest_coverline("build/test/test.js", 2467);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Value should be null."), null, actual);
    ...
    isUndefined : function (actual, message) {
        _yuitest_coverfunc("build/test/test.js", "isUndefined", 2479);
_yuitest_coverline("build/test/test.js", 2480);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2481);
if (typeof actual != "undefined") {
            _yuitest_coverline("build/test/test.js", 2482);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Value should be undefined."), undefined, actual);
    ...
    isArray : function (actual, message) {
        _yuitest_coverfunc("build/test/test.js", "isArray", 2497);
_yuitest_coverline("build/test/test.js", 2498);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2499);
var shouldFail = false;
        _yuitest_coverline("build/test/test.js", 2500);
if (Array.isArray){
            _yuitest_coverline("build/test/test.js", 2501);
shouldFail = !Array.isArray(actual);
        } else {
            _yuitest_coverline("build/test/test.js", 2503);
...
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Value should be an array."), actual);
    ...
    isBoolean : function (actual, message) {
        _yuitest_coverfunc("build/test/test.js", "isBoolean", 2517);
_yuitest_coverline("build/test/test.js", 2518);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2519);
if (typeof actual != "boolean"){
            _yuitest_coverline("build/test/test.js", 2520);
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Value should be a Boolean."), actual);
    ...
    isFunction : function (actual, message) {
        _yuitest_coverfunc("build/test/test.js", "isFunction", 2531);
_yuitest_coverline("build/test/test.js", 2532);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2533);
if (!(actual instanceof Function)){
            _yuitest_coverline("build/test/test.js", 2534);
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Value should be a function."), actual);
    ...
    isInstanceOf : function (expected, actual, message) {
        _yuitest_coverfunc("build/test/test.js", "isInstanceOf", 2548);
_yuitest_coverline("build/test/test.js", 2549);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2550);
if (!(actual instanceof expected)){
            _yuitest_coverline("build/test/test.js", 2551);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Value isn't an instance of expected type."), expected, actual);
    ...
    isNumber : function (actual, message) {
        _yuitest_coverfunc("build/test/test.js", "isNumber", 2562);
_yuitest_coverline("build/test/test.js", 2563);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2564);
if (typeof actual != "number"){
            _yuitest_coverline("build/test/test.js", 2565);
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Value should be a number."), actual);
    ...
    isObject : function (actual, message) {
        _yuitest_coverfunc("build/test/test.js", "isObject", 2576);
_yuitest_coverline("build/test/test.js", 2577);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2578);
if (!actual || (typeof actual != "object" && typeof actual != "function")){
            _yuitest_coverline("build/test/test.js", 2579);
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Value should be an object."), actual);
    ...
    isString : function (actual, message) {
        _yuitest_coverfunc("build/test/test.js", "isString", 2590);
_yuitest_coverline("build/test/test.js", 2591);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2592);
if (typeof actual != "string"){
            _yuitest_coverline("build/test/test.js", 2593);
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Value should be a string."), actual);
    ...
    isTypeOf : function (expectedType, actualValue, message){
        _yuitest_coverfunc("build/test/test.js", "isTypeOf", 2605);
_yuitest_coverline("build/test/test.js", 2606);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2607);
if (typeof actualValue != expectedType){
            _yuitest_coverline("build/test/test.js", 2608);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Value should be of type " + expectedType + "."), expectedType, typeof actualValue);
    ...
    throwsError: function(expectedError, method, message){
        _yuitest_coverfunc("build/test/test.js", "throwsError", 2631);
_yuitest_coverline("build/test/test.js", 2632);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2633);
var error = false;
    
        _yuitest_coverline("build/test/test.js", 2635);
try {
            _yuitest_coverline("build/test/test.js", 2636);
method();        
        } catch (thrown) {
...
if (thrown.message != expectedError){
                    _yuitest_coverline("build/test/test.js", 2644);
error = true;
                }
            } else {_yuitest_coverline("build/test/test.js", 2646);
...
if (!(thrown instanceof expectedError.constructor) || 
                    ...
                    _yuitest_coverline("build/test/test.js", 2658);
error = true;
                }
...
if (error){
                _yuitest_coverline("build/test/test.js", 2666);
 ...
 * @constructor
 */ 
_yuitest_coverline("build/test/test.js", 2688);
YUITest.AssertionError = function (message){
     ...
     * @property message
     */
    _yuitest_coverfunc("build/test/test.js", "AssertionError", 2688);
...
_yuitest_coverline("build/test/test.js", 2705);
YUITest.AssertionError.prototype = {
     ...
     */
    getMessage : function () {
        _yuitest_coverfunc("build/test/test.js", "getMessage", 2716);
_yuitest_coverline("build/test/test.js", 2717);
return this.message;
    },
     ...
     */
    toString : function () {
        _yuitest_coverfunc("build/test/test.js", "toString", 2725);
_yuitest_coverline("build/test/test.js", 2726);
 ...
 * @constructor
 */ 
_yuitest_coverline("build/test/test.js", 2743);
YUITest.ComparisonFailure = function (message, expected, actual){

    //call superclass
    _yuitest_coverfunc("build/test/test.js", "ComparisonFailure", 2743);
_yuitest_coverline("build/test/test.js", 2746);
...
_yuitest_coverline("build/test/test.js", 2772);
YUITest.ComparisonFailure.prototype = new YUITest.AssertionError;

//restore constructor
_yuitest_coverline("build/test/test.js", 2775);
 ...
 * @return {String} A string describing the error.
 */
_yuitest_coverline("build/test/test.js", 2783);
YUITest.ComparisonFailure.prototype.getMessage = function(){
    _yuitest_coverfunc("build/test/test.js", "getMessage", 2783);
_yuitest_coverline("build/test/test.js", 2784);
return this.message + "\nExpected: " + this.expected + " (" + (typeof this.expected) + ")"  +
 ...
 * @static
 */
_yuitest_coverline("build/test/test.js", 2794);
YUITest.CoverageFormat = {
    ...
    JSON: function(coverage){
        _yuitest_coverfunc("build/test/test.js", "JSON", 2804);
_yuitest_coverline("build/test/test.js", 2805);
return YUITest.Util.JSON.stringify(coverage);
    ...
    XdebugJSON: function(coverage){
        ...
        _yuitest_coverfunc("build/test/test.js", "XdebugJSON", 2818);
_yuitest_coverline("build/test/test.js", 2820);
var report = {};
        _yuitest_coverline("build/test/test.js", 2821);
for (var prop in coverage){
            _yuitest_coverline("build/test/test.js", 2822);
if (coverage.hasOwnProperty(prop)){
                _yuitest_coverline("build/test/test.js", 2823);
...
_yuitest_coverline("build/test/test.js", 2841);
YUITest.DateAssert = {
    ...
    datesAreEqual : function (expected, actual, message){
        _yuitest_coverfunc("build/test/test.js", "datesAreEqual", 2851);
_yuitest_coverline("build/test/test.js", 2852);
YUITest.Assert._increment();        
        _yuitest_coverline("build/test/test.js", 2853);
if (expected instanceof Date && actual instanceof Date){
            _yuitest_coverline("build/test/test.js", 2854);
var msg = "";
            
            //check years first
            _yuitest_coverline("build/test/test.js", 2857);
...
msg = "Years should be equal.";
            ...
            //now check months
            _yuitest_coverline("build/test/test.js", 2862);
...
msg = "Months should be equal.";
            ...
            _yuitest_coverline("build/test/test.js", 2867);
if (expected.getDate() != actual.getDate()){
                _yuitest_coverline("build/test/test.js", 2868);
msg = "Days of month should be equal.";
            }                
            
            _yuitest_coverline("build/test/test.js", 2871);
if (msg.length){
                _yuitest_coverline("build/test/test.js", 2872);
...
throw new TypeError("YUITest.DateAssert.datesAreEqual(): Expected and actual values must be Date objects.");
    ...
    timesAreEqual : function (expected, actual, message){
        _yuitest_coverfunc("build/test/test.js", "timesAreEqual", 2887);
_yuitest_coverline("build/test/test.js", 2888);
YUITest.Assert._increment();
        _yuitest_coverline("build/test/test.js", 2889);
if (expected instanceof Date && actual instanceof Date){
            _yuitest_coverline("build/test/test.js", 2890);
var msg = "";
            
            //check hours first
            _yuitest_coverline("build/test/test.js", 2893);
...
msg = "Hours should be equal.";
            ...
            //now check minutes
            _yuitest_coverline("build/test/test.js", 2898);
...
msg = "Minutes should be equal.";
            ...
            _yuitest_coverline("build/test/test.js", 2903);
if (expected.getSeconds() != actual.getSeconds()){
                _yuitest_coverline("build/test/test.js", 2904);
msg = "Seconds should be equal.";
            }                
            
            _yuitest_coverline("build/test/test.js", 2907);
if (msg.length){
                _yuitest_coverline("build/test/test.js", 2908);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, msg), expected, actual);
            }
        } else {
 ...
 */
_yuitest_coverline("build/test/test.js", 2924);
YUITest.Mock = function(template){

    //use blank object is nothing is passed in
    _yuitest_coverfunc("build/test/test.js", "Mock", 2924);
_yuitest_coverline("build/test/test.js", 2927);
template = template || {};
    
    _yuitest_coverline("build/test/test.js", 2929);
var mock,
        name;
...
f.prototype = template;
        _yuitest_coverline("build/test/test.js", 2937);
mock = new f();
    } catch (ex) {
        _yuitest_coverline("build/test/test.js", 2939);
mock = {};
    }
...
mock[name] = function(name){
                    _yuitest_coverfunc("build/test/test.js", "]", 2946);
_yuitest_coverline("build/test/test.js", 2947);
return function(){
                        _yuitest_coverfunc("build/test/test.js", "(anonymous 11)", 2947);
_yuitest_coverline("build/test/test.js", 2948);
YUITest.Assert.fail("Method " + name + "() was called but was not expected to be.");
    ...
    //return it
    _yuitest_coverline("build/test/test.js", 2956);
return mock;    
};
 ...
 * @static
 */ 
_yuitest_coverline("build/test/test.js", 2979);
YUITest.Mock.expect = function(mock /*:Object*/, expectation /*:Object*/){

    //make sure there's a place to store the expectations
    _yuitest_coverfunc("build/test/test.js", "expect", 2979);
_yuitest_coverline("build/test/test.js", 2982);
if (!mock.__expectations) {
        _yuitest_coverline("build/test/test.js", 2983);
mock.__expectations = {};
    }

    //method expectation
    _yuitest_coverline("build/test/test.js", 2987);
...
var name = expectation.method,
        ...
        //save expectations
        _yuitest_coverline("build/test/test.js", 2998);
mock.__expectations[name] = expectation;
        _yuitest_coverline("build/test/test.js", 2999);
expectation.callCount = callCount;
        _yuitest_coverline("build/test/test.js", 3000);
expectation.actualCallCount = 0;
            
        //process arguments
        _yuitest_coverline("build/test/test.js", 3003);
...
mock[name] = function(){   
                _yuitest_coverfunc("build/test/test.js", "]", 3011);
_yuitest_coverline("build/test/test.js", 3012);
try {
                    _yuitest_coverline("build/test/test.js", 3013);
expectation.actualCallCount++;
                    _yuitest_coverline("build/test/test.js", 3014);
YUITest.Assert.areEqual(args.length, arguments.length, "Method " + name + "() passed incorrect number of arguments.");
                    _yuitest_coverline("build/test/test.js", 3015);
...
YUITest.TestRunner._handleError(ex);
                ...
                // by our 'run' function. 
                _yuitest_coverline("build/test/test.js", 3031);
return expectation.hasOwnProperty('returns') ? result : runResult;
            };
        } else {
        
            //method should fail if called when not expected
            _yuitest_coverline("build/test/test.js", 3036);
mock[name] = function(){
                _yuitest_coverfunc("build/test/test.js", "]", 3036);
...
YUITest.Assert.fail("Method " + name + "() should not have been called.");
                    ...
                    //route through TestRunner for proper handling
                    _yuitest_coverline("build/test/test.js", 3041);
YUITest.TestRunner._handleError(ex);
                }                    
            };
        }
    } else {_yuitest_coverline("build/test/test.js", 3045);
 ...
 * @static
 */ 
_yuitest_coverline("build/test/test.js", 3059);
YUITest.Mock.verify = function(mock){    
    _yuitest_coverfunc("build/test/test.js", "verify", 3059);
_yuitest_coverline("build/test/test.js", 3060);
try {
    
        _yuitest_coverline("build/test/test.js", 3062);
for (var name in mock.__expectations){
            _yuitest_coverline("build/test/test.js", 3063);
if (mock.__expectations.hasOwnProperty(name)){
                _yuitest_coverline("build/test/test.js", 3064);
...
YUITest.Assert.areEqual(expectation.callCount, expectation.actualCallCount, "Method " + expectation.method + "() wasn't called the expected number of times.");
                } else {_yuitest_coverline("build/test/test.js", 3067);
if (expectation.property){
 ...
 * @constructor
 */
_yuitest_coverline("build/test/test.js", 3089);
YUITest.Mock.Value = function(method, originalArgs, message){
    _yuitest_coverfunc("build/test/test.js", "Value", 3089);
_yuitest_coverline("build/test/test.js", 3090);
if (this instanceof YUITest.Mock.Value){
        _yuitest_coverline("build/test/test.js", 3091);
this.verify = function(value){
            _yuitest_coverfunc("build/test/test.js", "verify", 3091);
_yuitest_coverline("build/test/test.js", 3092);
var args = [].concat(originalArgs || []);
            _yuitest_coverline("build/test/test.js", 3093);
args.push(value);
            _yuitest_coverline("build/test/test.js", 3094);
args.push(message);
 ...
 * @type Function
 */
_yuitest_coverline("build/test/test.js", 3108);
 ...
 * @type Function
 */
_yuitest_coverline("build/test/test.js", 3116);
 ...
 * @type Function
 */
_yuitest_coverline("build/test/test.js", 3124);
 ...
 * @type Function
 */
_yuitest_coverline("build/test/test.js", 3132);
 ...
 * @type Function
 */
_yuitest_coverline("build/test/test.js", 3140);
 ...
 * @type Function
 */
_yuitest_coverline("build/test/test.js", 3148);
 ...
 * @static
 */
_yuitest_coverline("build/test/test.js", 3158);
YUITest.ObjectAssert = {
     ...
     */
    areEqual: function(expected, actual, message) {
        _yuitest_coverfunc("build/test/test.js", "areEqual", 3170);
_yuitest_coverline("build/test/test.js", 3171);
YUITest.Assert._increment();         
        
        _yuitest_coverline("build/test/test.js", 3173);
...
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Object should have " + expectedKeys.length + " keys but has " + actualKeys.length));
        ...
        //then check values
        _yuitest_coverline("build/test/test.js", 3182);
...
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Values should be equal for property " + name), expected[name], actual[name]);
    ...
    hasKey: function (propertyName, object, message) {
        _yuitest_coverfunc("build/test/test.js", "hasKey", 3200);
_yuitest_coverline("build/test/test.js", 3201);
YUITest.ObjectAssert.ownsOrInheritsKey(propertyName, object, message);   
    ...
    hasKeys: function (properties, object, message) {
        _yuitest_coverfunc("build/test/test.js", "hasKeys", 3213);
_yuitest_coverline("build/test/test.js", 3214);
YUITest.ObjectAssert.ownsOrInheritsKeys(properties, object, message);
    ...
    inheritsKey: function (propertyName, object, message) {
        _yuitest_coverfunc("build/test/test.js", "inheritsKey", 3225);
_yuitest_coverline("build/test/test.js", 3226);
YUITest.Assert._increment();               
        _yuitest_coverline("build/test/test.js", 3227);
if (!(propertyName in object && !object.hasOwnProperty(propertyName))){
            _yuitest_coverline("build/test/test.js", 3228);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Property '" + propertyName + "' not found on object instance."));
    ...
    inheritsKeys: function (properties, object, message) {
        _yuitest_coverfunc("build/test/test.js", "inheritsKeys", 3240);
_yuitest_coverline("build/test/test.js", 3241);
YUITest.Assert._increment();        
        _yuitest_coverline("build/test/test.js", 3242);
for (var i=0; i < properties.length; i++){
            _yuitest_coverline("build/test/test.js", 3243);
if (!(propertyName in object && !object.hasOwnProperty(properties[i]))){
                _yuitest_coverline("build/test/test.js", 3244);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Property '" + properties[i] + "' not found on object instance."));
    ...
    ownsKey: function (propertyName, object, message) {
        _yuitest_coverfunc("build/test/test.js", "ownsKey", 3257);
_yuitest_coverline("build/test/test.js", 3258);
YUITest.Assert._increment();               
        _yuitest_coverline("build/test/test.js", 3259);
if (!object.hasOwnProperty(propertyName)){
            _yuitest_coverline("build/test/test.js", 3260);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Property '" + propertyName + "' not found on object instance."));
        }     
    },
    ...
    ownsKeys: function (properties, object, message) {
        _yuitest_coverfunc("build/test/test.js", "ownsKeys", 3272);
_yuitest_coverline("build/test/test.js", 3273);
YUITest.Assert._increment();        
        _yuitest_coverline("build/test/test.js", 3274);
for (var i=0; i < properties.length; i++){
            _yuitest_coverline("build/test/test.js", 3275);
if (!object.hasOwnProperty(properties[i])){
                _yuitest_coverline("build/test/test.js", 3276);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Property '" + properties[i] + "' not found on object instance."));
            }      
        }
    },
    ...
    ownsNoKeys : function (object, message) {
        _yuitest_coverfunc("build/test/test.js", "ownsNoKeys", 3288);
_yuitest_coverline("build/test/test.js", 3289);
YUITest.Assert._increment();  
        _yuitest_coverline("build/test/test.js", 3290);
var count = 0,
            name;
        _yuitest_coverline("build/test/test.js", 3292);
for (name in object){
            _yuitest_coverline("build/test/test.js", 3293);
if (object.hasOwnProperty(name)){
                _yuitest_coverline("build/test/test.js", 3294);
count++;
            }
        }
...
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Object owns " + count + " properties but should own none."));        
    ...
    ownsOrInheritsKey: function (propertyName, object, message) {
        _yuitest_coverfunc("build/test/test.js", "ownsOrInheritsKey", 3312);
_yuitest_coverline("build/test/test.js", 3313);
YUITest.Assert._increment();               
        _yuitest_coverline("build/test/test.js", 3314);
if (!(propertyName in object)){
            _yuitest_coverline("build/test/test.js", 3315);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Property '" + propertyName + "' not found on object."));
    ...
    ownsOrInheritsKeys: function (properties, object, message) {
        _yuitest_coverfunc("build/test/test.js", "ownsOrInheritsKeys", 3327);
_yuitest_coverline("build/test/test.js", 3328);
YUITest.Assert._increment();  
        _yuitest_coverline("build/test/test.js", 3329);
for (var i=0; i < properties.length; i++){
            _yuitest_coverline("build/test/test.js", 3330);
if (!(properties[i] in object)){
                _yuitest_coverline("build/test/test.js", 3331);
 ...
 */
_yuitest_coverline("build/test/test.js", 3346);
YUITest.Results = function(name){
     ...
     * @property name
     */
    _yuitest_coverfunc("build/test/test.js", "Results", 3346);
 ...
 * @return {void}
 */
_yuitest_coverline("build/test/test.js", 3404);
YUITest.Results.prototype.include = function(results){
    _yuitest_coverfunc("build/test/test.js", "include", 3404);
_yuitest_coverline("build/test/test.js", 3405);
this.passed += results.passed;
    _yuitest_coverline("build/test/test.js", 3406);
this.failed += results.failed;
    _yuitest_coverline("build/test/test.js", 3407);
this.ignored += results.ignored;
    _yuitest_coverline("build/test/test.js", 3408);
this.total += results.total;
    _yuitest_coverline("build/test/test.js", 3409);
 ...
 * @constructor
 */ 
_yuitest_coverline("build/test/test.js", 3421);
YUITest.ShouldError = function (message){

    //call superclass
    _yuitest_coverfunc("build/test/test.js", "ShouldError", 3421);
_yuitest_coverline("build/test/test.js", 3424);
...
//inherit from YUITest.AssertionError
_yuitest_coverline("build/test/test.js", 3436);
 ...
 * @constructor
 */ 
_yuitest_coverline("build/test/test.js", 3451);
YUITest.ShouldFail = function (message){

    //call superclass
    _yuitest_coverfunc("build/test/test.js", "ShouldFail", 3451);
_yuitest_coverline("build/test/test.js", 3454);
...
//inherit from YUITest.AssertionError
_yuitest_coverline("build/test/test.js", 3466);
 ...
 * @constructor
 */  
_yuitest_coverline("build/test/test.js", 3483);
YUITest.UnexpectedError = function (cause){

    //call superclass
    _yuitest_coverfunc("build/test/test.js", "UnexpectedError", 3483);
_yuitest_coverline("build/test/test.js", 3486);
...
//inherit from YUITest.AssertionError
_yuitest_coverline("build/test/test.js", 3512);
 ...
 * @constructor
 */ 
_yuitest_coverline("build/test/test.js", 3530);
YUITest.UnexpectedValue = function (message, unexpected){

    //call superclass
    _yuitest_coverfunc("build/test/test.js", "UnexpectedValue", 3530);
_yuitest_coverline("build/test/test.js", 3533);
YUITest.AssertionError.call(this, message);
...
//inherit from YUITest.AssertionError
_yuitest_coverline("build/test/test.js", 3552);
...
YUITest.UnexpectedValue.prototype.getMessage = function(){
    _yuitest_coverfunc("build/test/test.js", "getMessage", 3563);
_yuitest_coverline("build/test/test.js", 3564);
 ...
 *
 */
_yuitest_coverline("build/test/test.js", 3578);
YUITest.Wait = function (segment, delay) {
     ...
     * @property segment
     */
    _yuitest_coverfunc("build/test/test.js", "Wait", 3578);
...
_yuitest_coverline("build/test/test.js", 3597);
Y.Test = YUITest;
_yuitest_coverline("build/test/test.js", 3598);
Y.Object.each(YUITest, function(item, name) {
    _yuitest_coverfunc("build/test/test.js", "(anonymous 14)", 3598);
...
_yuitest_coverline("build/test/test.js", 3609);
Y.Mock = Y.Test.Mock;
_yuitest_coverline("build/test/test.js", 3610);
Y.ObjectAssert = Y.Test.ObjectAssert;
_yuitest_coverline("build/test/test.js", 3611);
...
Y.Test.ArrayAssert.itemsAreEqual = function(expected, actual, message) {
    _yuitest_coverfunc("build/test/test.js", "itemsAreEqual", 3617);
 ...
 * @static
 */
_yuitest_coverline("build/test/test.js", 3631);
Y.assert = function(condition, message){
    _yuitest_coverfunc("build/test/test.js", "assert", 3631);
_yuitest_coverline("build/test/test.js", 3632);
Y.Assert._increment();
    _yuitest_coverline("build/test/test.js", 3633);
if (!condition){
        _yuitest_coverline("build/test/test.js", 3634);
 ...
 * @static
 */
_yuitest_coverline("build/test/test.js", 3645);
Y.fail = Y.Assert.fail; 

_yuitest_coverline("build/test/test.js", 3647);
Y.Test.Runner.once = Y.Test.Runner.subscribe;

_yuitest_coverline("build/test/test.js", 3649);
Y.Test.Runner.disableLogging = function() {
    _yuitest_coverfunc("build/test/test.js", "disableLogging", 3649);
_yuitest_coverline("build/test/test.js", 3650);
Y.Test.Runner._log = false;
};

_yuitest_coverline("build/test/test.js", 3653);
Y.Test.Runner.enableLogging = function() {
    _yuitest_coverfunc("build/test/test.js", "enableLogging", 3653);
...
_yuitest_coverline("build/test/test.js", 3663);
if (!YUI.YUITest) {
...
Y.config.win.YUITest = YUITest;
    ...
    _yuitest_coverline("build/test/test.js", 3669);
YUI.YUITest = Y.Test;
...
messageType = "info";
                _yuitest_coverline("build/test/test.js", 3692);
break;
                
            case this.TEST_FAIL_EVENT:
                _yuitest_coverline("build/test/test.js", 3695);
message = event.testName + ": failed.\n" + event.error.getMessage();
                _yuitest_coverline("build/test/test.js", 3696);
messageType = "fail";
                _yuitest_coverline("build/test/test.js", 3697);
break;
                
            case this.TEST_IGNORE_EVENT:
                _yuitest_coverline("build/test/test.js", 3700);
message = event.testName + ": ignored.";
                _yuitest_coverline("build/test/test.js", 3701);
messageType = "ignore";
...
message = event.testName + ": passed.";
                _yuitest_coverline("build/test/test.js", 3706);
messageType = "pass";
...
message = "Test suite \"" + event.testSuite.name + "\" started.";
                _yuitest_coverline("build/test/test.js", 3711);
messageType = "info";
...
messageType = "info";
                _yuitest_coverline("build/test/test.js", 3721);
break;
                
            case this.TEST_CASE_BEGIN_EVENT:
                _yuitest_coverline("build/test/test.js", 3724);
message = "Test case \"" + event.testCase.name + "\" started.";
                _yuitest_coverline("build/test/test.js", 3725);
messageType = "info";
                _yuitest_coverline("build/test/test.js", 3726);
break;
...
messageType = "info";
                _yuitest_coverline("build/test/test.js", 3735);
break;
            default:
                _yuitest_coverline("build/test/test.js", 3737);
message = "Unexpected event " + event.type;
                _yuitest_coverline("build/test/test.js", 3738);
message = "info";
        }
...
if (i.indexOf('_EVENT') > -1) {
            _yuitest_coverline("build/test/test.js", 3751);
...
}, '3.7.0pr1', {"requires": ["event-simulate", "event-custom", "substitute", "json-stringify"]});
