...
_yuitest_coverline("build/model/model.js", 27);
...
_yuitest_coverline("build/model/model.js", 95);
function Model() {
    _yuitest_coverfunc("build/model/model.js", "Model", 95);
_yuitest_coverline("build/model/model.js", 96);
Model.superclass.constructor.apply(this, arguments);
}

_yuitest_coverline("build/model/model.js", 99);
Y.Model = Y.extend(Model, Y.Base, {
    ...
    **/
    ...
    initializer: function (config) {
        _yuitest_coverfunc("build/model/model.js", "initializer", 199);
_yuitest_coverline("build/model/model.js", 200);
this.changed    = {};
        _yuitest_coverline("build/model/model.js", 201);
this.lastChange = {};
        _yuitest_coverline("build/model/model.js", 202);
this.lists      = [];
    },
    ...
    **/
    destroy: function (options, callback) {
        _yuitest_coverfunc("build/model/model.js", "destroy", 232);
_yuitest_coverline("build/model/model.js", 233);
var self = this;

        // Allow callback as only arg.
        _yuitest_coverline("build/model/model.js", 236);
if (typeof options === 'function') {
            _yuitest_coverline("build/model/model.js", 237);
callback = options;
            _yuitest_coverline("build/model/model.js", 238);
options  = null;
        }

        _yuitest_coverline("build/model/model.js", 241);
self.onceAfter('destroy', function () {
            _yuitest_coverfunc("build/model/model.js", "(anonymous 2)", 241);
_yuitest_coverline("build/model/model.js", 242);
function finish(err) {
                _yuitest_coverfunc("build/model/model.js", "finish", 242);
_yuitest_coverline("build/model/model.js", 243);
if (!err) {
                    _yuitest_coverline("build/model/model.js", 244);
YArray.each(self.lists.concat(), function (list) {
                        _yuitest_coverfunc("build/model/model.js", "(anonymous 3)", 244);
_yuitest_coverline("build/model/model.js", 245);
list.remove(self, options);
                    });
                }

                _yuitest_coverline("build/model/model.js", 249);
callback && callback.apply(null, arguments);
            }

            _yuitest_coverline("build/model/model.js", 252);
if (options && (options.remove || options['delete'])) {
                _yuitest_coverline("build/model/model.js", 253);
self.sync('delete', options, finish);
            } else {
                _yuitest_coverline("build/model/model.js", 255);
finish();
            }
        });

        _yuitest_coverline("build/model/model.js", 259);
return Model.superclass.destroy.call(self);
    ...
    **/
    generateClientId: function () {
        _yuitest_coverfunc("build/model/model.js", "generateClientId", 270);
_yuitest_coverline("build/model/model.js", 271);
GlobalEnv.lastId || (GlobalEnv.lastId = 0);
        _yuitest_coverline("build/model/model.js", 272);
return this.constructor.NAME + '_' + (GlobalEnv.lastId += 1);
    ...
    **/
    getAsHTML: function (name) {
        _yuitest_coverfunc("build/model/model.js", "getAsHTML", 314);
_yuitest_coverline("build/model/model.js", 315);
var value = this.get(name);
        _yuitest_coverline("build/model/model.js", 316);
return Y.Escape.html(Lang.isValue(value) ? String(value) : '');
    ...
    **/
    getAsURL: function (name) {
        _yuitest_coverfunc("build/model/model.js", "getAsURL", 328);
_yuitest_coverline("build/model/model.js", 329);
var value = this.get(name);
        _yuitest_coverline("build/model/model.js", 330);
return encodeURIComponent(Lang.isValue(value) ? String(value) : '');
    ...
    **/
    isModified: function () {
        _yuitest_coverfunc("build/model/model.js", "isModified", 344);
_yuitest_coverline("build/model/model.js", 345);
return this.isNew() || !YObject.isEmpty(this.changed);
    ...
    **/
    isNew: function () {
        _yuitest_coverfunc("build/model/model.js", "isNew", 360);
_yuitest_coverline("build/model/model.js", 361);
return !Lang.isValue(this.get('id'));
    ...
    **/
    load: function (options, callback) {
        _yuitest_coverfunc("build/model/model.js", "load", 390);
_yuitest_coverline("build/model/model.js", 391);
var self = this;

        // Allow callback as only arg.
        _yuitest_coverline("build/model/model.js", 394);
if (typeof options === 'function') {
            _yuitest_coverline("build/model/model.js", 395);
callback = options;
            _yuitest_coverline("build/model/model.js", 396);
options  = {};
        }

        _yuitest_coverline("build/model/model.js", 399);
options || (options = {});

        _yuitest_coverline("build/model/model.js", 401);
self.sync('read', options, function (err, response) {
            _yuitest_coverfunc("build/model/model.js", "(anonymous 4)", 401);
_yuitest_coverline("build/model/model.js", 402);
var facade = {
                    options : options,
                    response: response
                },
            ...
            _yuitest_coverline("build/model/model.js", 409);
if (err) {
                _yuitest_coverline("build/model/model.js", 410);
facade.error = err;
                _yuitest_coverline("build/model/model.js", 411);
facade.src   = 'load';

                _yuitest_coverline("build/model/model.js", 413);
self.fire(EVT_ERROR, facade);
            } else {
                // Lazy publish.
                _yuitest_coverline("build/model/model.js", 416);
if (!self._loadEvent) {
                    _yuitest_coverline("build/model/model.js", 417);
self._loadEvent = self.publish(EVT_LOAD, {
                        preventable: false
                    });
                }

                _yuitest_coverline("build/model/model.js", 422);
parsed = facade.parsed = self._parse(response);

                _yuitest_coverline("build/model/model.js", 424);
self.setAttrs(parsed, options);
                _yuitest_coverline("build/model/model.js", 425);
self.changed = {};

                _yuitest_coverline("build/model/model.js", 427);
self.fire(EVT_LOAD, facade);
            }

            _yuitest_coverline("build/model/model.js", 430);
callback && callback.apply(null, arguments);
        });

        _yuitest_coverline("build/model/model.js", 433);
return self;
    },
    ...
    **/
    parse: function (response) {
        _yuitest_coverfunc("build/model/model.js", "parse", 453);
_yuitest_coverline("build/model/model.js", 454);
if (typeof response === 'string') {
            _yuitest_coverline("build/model/model.js", 455);
try {
                _yuitest_coverline("build/model/model.js", 456);
return Y.JSON.parse(response);
            } catch (ex) {
                _yuitest_coverline("build/model/model.js", 458);
this.fire(EVT_ERROR, {
                    error   : ex,
                    response: response,
                    src     : 'parse'
                ...
                _yuitest_coverline("build/model/model.js", 464);
return null;
            }
        }

        _yuitest_coverline("build/model/model.js", 468);
return response;
    },
    ...
    **/
    save: function (options, callback) {
        _yuitest_coverfunc("build/model/model.js", "save", 498);
_yuitest_coverline("build/model/model.js", 499);
var self = this;

        // Allow callback as only arg.
        _yuitest_coverline("build/model/model.js", 502);
if (typeof options === 'function') {
            _yuitest_coverline("build/model/model.js", 503);
callback = options;
            _yuitest_coverline("build/model/model.js", 504);
options  = {};
        }

        _yuitest_coverline("build/model/model.js", 507);
options || (options = {});

        _yuitest_coverline("build/model/model.js", 509);
self._validate(self.toJSON(), function (err) {
            _yuitest_coverfunc("build/model/model.js", "(anonymous 5)", 509);
_yuitest_coverline("build/model/model.js", 510);
if (err) {
                _yuitest_coverline("build/model/model.js", 511);
callback && callback.call(null, err);
                _yuitest_coverline("build/model/model.js", 512);
return;
            }

            _yuitest_coverline("build/model/model.js", 515);
self.sync(self.isNew() ? 'create' : 'update', options, function (err, response) {
                _yuitest_coverfunc("build/model/model.js", "(anonymous 6)", 515);
_yuitest_coverline("build/model/model.js", 516);
var facade = {
                        options : options,
                        response: response
                    },
                ...
                _yuitest_coverline("build/model/model.js", 523);
if (err) {
                    _yuitest_coverline("build/model/model.js", 524);
facade.error = err;
                    _yuitest_coverline("build/model/model.js", 525);
facade.src   = 'save';

                    _yuitest_coverline("build/model/model.js", 527);
self.fire(EVT_ERROR, facade);
                } else {
                    // Lazy publish.
                    _yuitest_coverline("build/model/model.js", 530);
if (!self._saveEvent) {
                        _yuitest_coverline("build/model/model.js", 531);
self._saveEvent = self.publish(EVT_SAVE, {
                            preventable: false
                        });
                    }

                    _yuitest_coverline("build/model/model.js", 536);
if (response) {
                        _yuitest_coverline("build/model/model.js", 537);
parsed = facade.parsed = self._parse(response);
                        _yuitest_coverline("build/model/model.js", 538);
self.setAttrs(parsed, options);
                    }

                    _yuitest_coverline("build/model/model.js", 541);
self.changed = {};
                    _yuitest_coverline("build/model/model.js", 542);
self.fire(EVT_SAVE, facade);
                }

                _yuitest_coverline("build/model/model.js", 545);
callback && callback.apply(null, arguments);
            });
        });

        _yuitest_coverline("build/model/model.js", 549);
return self;
    },
    ...
    **/
    set: function (name, value, options) {
        _yuitest_coverfunc("build/model/model.js", "set", 570);
_yuitest_coverline("build/model/model.js", 571);
var attributes = {};
        _yuitest_coverline("build/model/model.js", 572);
attributes[name] = value;

        _yuitest_coverline("build/model/model.js", 574);
return this.setAttrs(attributes, options);
    ...
    **/
    setAttrs: function (attributes, options) {
        _yuitest_coverfunc("build/model/model.js", "setAttrs", 595);
_yuitest_coverline("build/model/model.js", 596);
var idAttribute = this.idAttribute,
            changed, e, key, lastChange, transaction;

        _yuitest_coverline("build/model/model.js", 599);
options || (options = {});
        _yuitest_coverline("build/model/model.js", 600);
transaction = options._transaction = {};

        // When a custom id attribute is in use, always keep the default `id`
        // attribute in sync.
        _yuitest_coverline("build/model/model.js", 604);
if (idAttribute !== 'id') {
            // So we don't modify someone else's object.
            _yuitest_coverline("build/model/model.js", 606);
attributes = Y.merge(attributes);

            _yuitest_coverline("build/model/model.js", 608);
if (YObject.owns(attributes, idAttribute)) {
                _yuitest_coverline("build/model/model.js", 609);
attributes.id = attributes[idAttribute];
            } else {_yuitest_coverline("build/model/model.js", 610);
if (YObject.owns(attributes, 'id')) {
                _yuitest_coverline("build/model/model.js", 611);
attributes[idAttribute] = attributes.id;
            }}
        }

        _yuitest_coverline("build/model/model.js", 615);
for (key in attributes) {
            _yuitest_coverline("build/model/model.js", 616);
if (YObject.owns(attributes, key)) {
                _yuitest_coverline("build/model/model.js", 617);
this._setAttr(key, attributes[key], options);
            }
        }

        _yuitest_coverline("build/model/model.js", 621);
if (!YObject.isEmpty(transaction)) {
            _yuitest_coverline("build/model/model.js", 622);
changed    = this.changed;
            _yuitest_coverline("build/model/model.js", 623);
lastChange = this.lastChange = {};

            _yuitest_coverline("build/model/model.js", 625);
for (key in transaction) {
                _yuitest_coverline("build/model/model.js", 626);
if (YObject.owns(transaction, key)) {
                    _yuitest_coverline("build/model/model.js", 627);
e = transaction[key];

                    _yuitest_coverline("build/model/model.js", 629);
changed[key] = e.newVal;

                    _yuitest_coverline("build/model/model.js", 631);
lastChange[key] = {
                        newVal : e.newVal,
                        prevVal: e.prevVal,
                        src    : e.src || null
            ...
            _yuitest_coverline("build/model/model.js", 639);
if (!options.silent) {
                // Lazy publish for the change event.
                _yuitest_coverline("build/model/model.js", 641);
if (!this._changeEvent) {
                    _yuitest_coverline("build/model/model.js", 642);
this._changeEvent = this.publish(EVT_CHANGE, {
                        preventable: false
                    });
                }

                _yuitest_coverline("build/model/model.js", 647);
this.fire(EVT_CHANGE, Y.merge(options, {changed: lastChange}));
            }
        }

        _yuitest_coverline("build/model/model.js", 651);
return this;
    },
    ...
    **/
    sync: function (/* action, options, callback */) {
        _yuitest_coverfunc("build/model/model.js", "sync", 676);
_yuitest_coverline("build/model/model.js", 677);
var callback = YArray(arguments, 0, true).pop();

        _yuitest_coverline("build/model/model.js", 679);
if (typeof callback === 'function') {
            _yuitest_coverline("build/model/model.js", 680);
callback();
        }
    },
    ...
    **/
    toJSON: function () {
        _yuitest_coverfunc("build/model/model.js", "toJSON", 704);
_yuitest_coverline("build/model/model.js", 705);
var attrs = this.getAttrs();

        _yuitest_coverline("build/model/model.js", 707);
delete attrs.clientId;
        _yuitest_coverline("build/model/model.js", 708);
delete attrs.destroyed;
        _yuitest_coverline("build/model/model.js", 709);
delete attrs.initialized;

        _yuitest_coverline("build/model/model.js", 711);
if (this.idAttribute !== 'id') {
            _yuitest_coverline("build/model/model.js", 712);
delete attrs.id;
        }

        _yuitest_coverline("build/model/model.js", 715);
return attrs;
    },
    ...
    **/
    undo: function (attrNames, options) {
        _yuitest_coverfunc("build/model/model.js", "undo", 740);
_yuitest_coverline("build/model/model.js", 741);
var lastChange  = this.lastChange,
            idAttribute = this.idAttribute,
            toUndo      = {},
            needUndo;

        _yuitest_coverline("build/model/model.js", 746);
attrNames || (attrNames = YObject.keys(lastChange));

        _yuitest_coverline("build/model/model.js", 748);
YArray.each(attrNames, function (name) {
            _yuitest_coverfunc("build/model/model.js", "(anonymous 7)", 748);
_yuitest_coverline("build/model/model.js", 749);
if (YObject.owns(lastChange, name)) {
                // Don't generate a double change for custom id attributes.
                _yuitest_coverline("build/model/model.js", 751);
name = name === idAttribute ? 'id' : name;

                _yuitest_coverline("build/model/model.js", 753);
needUndo     = true;
                _yuitest_coverline("build/model/model.js", 754);
toUndo[name] = lastChange[name].prevVal;
            }
        });

        _yuitest_coverline("build/model/model.js", 758);
return needUndo ? this.setAttrs(toUndo, options) : this;
    ...
    **/
    validate: function (attrs, callback) {
        _yuitest_coverfunc("build/model/model.js", "validate", 801);
_yuitest_coverline("build/model/model.js", 802);
callback && callback();
    },
    ...
    **/
    addAttr: function (name, config, lazy) {
        _yuitest_coverfunc("build/model/model.js", "addAttr", 825);
_yuitest_coverline("build/model/model.js", 826);
var idAttribute = this.idAttribute,
            idAttrCfg, id;

        _yuitest_coverline("build/model/model.js", 829);
if (idAttribute && name === idAttribute) {
            _yuitest_coverline("build/model/model.js", 830);
idAttrCfg = this._isLazyAttr('id') || this._getAttrCfg('id');
            _yuitest_coverline("build/model/model.js", 831);
id        = config.value === config.defaultValue ? null : config.value;

            _yuitest_coverline("build/model/model.js", 833);
if (!Lang.isValue(id)) {
                // Hunt for the id value.
                _yuitest_coverline("build/model/model.js", 835);
id = idAttrCfg.value === idAttrCfg.defaultValue ? null : idAttrCfg.value;

                _yuitest_coverline("build/model/model.js", 837);
if (!Lang.isValue(id)) {
                    // No id value provided on construction, check defaults.
                    _yuitest_coverline("build/model/model.js", 839);
id = Lang.isValue(config.defaultValue) ?
            ...
            _yuitest_coverline("build/model/model.js", 845);
config.value = id;

            // Make sure `id` is in sync.
            _yuitest_coverline("build/model/model.js", 848);
if (idAttrCfg.value !== id) {
                _yuitest_coverline("build/model/model.js", 849);
idAttrCfg.value = id;

                _yuitest_coverline("build/model/model.js", 851);
if (this._isLazyAttr('id')) {
                    _yuitest_coverline("build/model/model.js", 852);
this._state.add('id', 'lazy', idAttrCfg);
                } else {
                    _yuitest_coverline("build/model/model.js", 854);
this._state.add('id', 'value', id);
                }
            }
        }

        _yuitest_coverline("build/model/model.js", 859);
return Model.superclass.addAttr.apply(this, arguments);
    ...
    **/
    _parse: function (response) {
        _yuitest_coverfunc("build/model/model.js", "_parse", 876);
_yuitest_coverline("build/model/model.js", 877);
return this.parse(response);
    ...
    **/
    _validate: function (attributes, callback) {
        _yuitest_coverfunc("build/model/model.js", "_validate", 890);
_yuitest_coverline("build/model/model.js", 891);
var self = this;

        _yuitest_coverline("build/model/model.js", 893);
function handler(err) {
            _yuitest_coverfunc("build/model/model.js", "handler", 893);
_yuitest_coverline("build/model/model.js", 894);
if (Lang.isValue(err)) {
                // Validation failed. Fire an error.
                _yuitest_coverline("build/model/model.js", 896);
self.fire(EVT_ERROR, {
                ...
                _yuitest_coverline("build/model/model.js", 902);
callback(err);
                _yuitest_coverline("build/model/model.js", 903);
return;
            }

            _yuitest_coverline("build/model/model.js", 906);
callback();
        }

        _yuitest_coverline("build/model/model.js", 909);
if (self.validate.length === 1) {
            // Backcompat for 3.4.x-style synchronous validate() functions that
            // don't take a callback argument.
            _yuitest_coverline("build/model/model.js", 912);
handler(self.validate(attributes, handler));
        } else {
            _yuitest_coverline("build/model/model.js", 914);
self.validate(attributes, handler);
    ...
    **/
    _defAttrChangeFn: function (e) {
        _yuitest_coverfunc("build/model/model.js", "_defAttrChangeFn", 928);
_yuitest_coverline("build/model/model.js", 929);
var attrName = e.attrName;

        _yuitest_coverline("build/model/model.js", 931);
if (!this._setAttrVal(attrName, e.subAttrName, e.prevVal, e.newVal)) {
            // Prevent "after" listeners from being invoked since nothing changed.
            _yuitest_coverline("build/model/model.js", 933);
e.stopImmediatePropagation();
        } else {
            _yuitest_coverline("build/model/model.js", 935);
e.newVal = this.get(attrName);

            _yuitest_coverline("build/model/model.js", 937);
if (e._transaction) {
                _yuitest_coverline("build/model/model.js", 938);
...
}, '3.7.0pr1', {"requires": ["base-build", "escape", "json-parse"]});
