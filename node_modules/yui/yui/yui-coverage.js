...
*/
    /*global YUI*/
    /*global YUI_config*/
    _yuitest_coverline("build/yui/yui.js", 54);
var YUI = function() {
        _yuitest_coverfunc("build/yui/yui.js", "YUI", 54);
_yuitest_coverline("build/yui/yui.js", 55);
var i = 0,
            Y = this,
            args = arguments,
            l = args.length,
            instanceOf = function(o, type) {
                _yuitest_coverfunc("build/yui/yui.js", "instanceOf", 59);
_yuitest_coverline("build/yui/yui.js", 60);
...
if (!(instanceOf(Y, YUI))) {
            _yuitest_coverline("build/yui/yui.js", 65);
Y = new YUI();
        } else {
...
Y._init();
            ...
            */
            _yuitest_coverline("build/yui/yui.js", 96);
if (YUI.GlobalConfig) {
                _yuitest_coverline("build/yui/yui.js", 97);
Y.applyConfig(YUI.GlobalConfig);
            ...
            */
            _yuitest_coverline("build/yui/yui.js", 126);
if (gconf) {
                _yuitest_coverline("build/yui/yui.js", 127);
Y.applyConfig(gconf);
            }

            // bind the specified additional modules for this instance
            _yuitest_coverline("build/yui/yui.js", 131);
if (!l) {
                _yuitest_coverline("build/yui/yui.js", 132);
Y._setup();
            }
        }

        _yuitest_coverline("build/yui/yui.js", 136);
if (l) {
            // Each instance can accept one or more configuration objects.
            // These are applied after YUI.GlobalConfig and YUI_Config,
            // overriding values set in those config files if there is a '
            // matching property.
            _yuitest_coverline("build/yui/yui.js", 141);
for (; i < l; i++) {
                _yuitest_coverline("build/yui/yui.js", 142);
Y.applyConfig(args[i]);
            }

            _yuitest_coverline("build/yui/yui.js", 145);
Y._setup();
        }

        _yuitest_coverline("build/yui/yui.js", 148);
...
_yuitest_coverline("build/yui/yui.js", 153);
(function() {

    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 1)", 153);
...
var proto, prop,
        ...
        */
        ...
        add = function(el, type, fn, capture) {
            _yuitest_coverfunc("build/yui/yui.js", "add", 178);
_yuitest_coverline("build/yui/yui.js", 179);
if (el && el.addEventListener) {
                _yuitest_coverline("build/yui/yui.js", 180);
el.addEventListener(type, fn, capture);
            } else {_yuitest_coverline("build/yui/yui.js", 181);
...
el.attachEvent('on' + type, fn);
        ...
        remove = function(el, type, fn, capture) {
            _yuitest_coverfunc("build/yui/yui.js", "remove", 185);
_yuitest_coverline("build/yui/yui.js", 186);
if (el && el.removeEventListener) {
                // this can throw an uncaught exception in FF
                _yuitest_coverline("build/yui/yui.js", 188);
try {
                    _yuitest_coverline("build/yui/yui.js", 189);
el.removeEventListener(type, fn, capture);
                } catch (ex) {}
            } else {_yuitest_coverline("build/yui/yui.js", 191);
if (el && el.detachEvent) {
                _yuitest_coverline("build/yui/yui.js", 192);
el.detachEvent('on' + type, fn);
            }}
        },
        handleLoad = function() {
            _yuitest_coverfunc("build/yui/yui.js", "handleLoad", 195);
_yuitest_coverline("build/yui/yui.js", 196);
YUI.Env.windowLoaded = true;
            _yuitest_coverline("build/yui/yui.js", 197);
...
remove(window, 'load', handleLoad);
        ...
        getLoader = function(Y, o) {
            _yuitest_coverfunc("build/yui/yui.js", "getLoader", 202);
_yuitest_coverline("build/yui/yui.js", 203);
var loader = Y.Env._loader,
                lCore = [ 'loader-base' ],
                G_ENV = YUI.Env,
                mods = G_ENV.mods;

            _yuitest_coverline("build/yui/yui.js", 208);
if (loader) {
                //loader._config(Y.config);
                _yuitest_coverline("build/yui/yui.js", 210);
loader.ignoreRegistered = false;
                _yuitest_coverline("build/yui/yui.js", 211);
loader.onEnd = null;
...
loader = new Y.Loader(Y.config);
                _yuitest_coverline("build/yui/yui.js", 217);
Y.Env._loader = loader;
            }
            _yuitest_coverline("build/yui/yui.js", 219);
if (mods && mods.loader) {
                _yuitest_coverline("build/yui/yui.js", 220);
...
return loader;
        ...
        clobber = function(r, s) {
            _yuitest_coverfunc("build/yui/yui.js", "clobber", 227);
_yuitest_coverline("build/yui/yui.js", 228);
for (var i in s) {
                _yuitest_coverline("build/yui/yui.js", 229);
...
_yuitest_coverline("build/yui/yui.js", 239);
if (docEl && docClass.indexOf(DOC_LABEL) == -1) {
    _yuitest_coverline("build/yui/yui.js", 240);
if (docClass) {
...
docClass += DOC_LABEL;
    _yuitest_coverline("build/yui/yui.js", 244);
docEl.className = docClass;
}

_yuitest_coverline("build/yui/yui.js", 247);
if (VERSION.indexOf('@') > -1) {
    _yuitest_coverline("build/yui/yui.js", 248);
VERSION = '3.5.0'; // dev time hack for cdn test
}

_yuitest_coverline("build/yui/yui.js", 251);
proto = {
    /**
    ...
    applyConfig: function(o) {
        ...
        _yuitest_coverfunc("build/yui/yui.js", "applyConfig", 261);
_yuitest_coverline("build/yui/yui.js", 263);
o = o || NOOP;
...
var attr,
        ...
        _yuitest_coverline("build/yui/yui.js", 274);
for (name in o) {
            _yuitest_coverline("build/yui/yui.js", 275);
...
clobber(mods, attr);
                } else {_yuitest_coverline("build/yui/yui.js", 279);
...
config[name] = (attr && attr.contentWindow) || attr;
                    _yuitest_coverline("build/yui/yui.js", 285);
config.doc = config[name] ? config[name].document : null;
                } else {_yuitest_coverline("build/yui/yui.js", 286);
if (name == '_yuid') {
                    // preserve the guid
                } else {
                    _yuitest_coverline("build/yui/yui.js", 289);
config[name] = attr;
                }}}}}
            }
        }

        _yuitest_coverline("build/yui/yui.js", 294);
if (loader) {
            _yuitest_coverline("build/yui/yui.js", 295);
loader._config(o);
        }
    ...
    */
    _config: function(o) {
        _yuitest_coverfunc("build/yui/yui.js", "_config", 305);
_yuitest_coverline("build/yui/yui.js", 306);
this.applyConfig(o);
    },
     ...
     */
    _init: function() {
        _yuitest_coverfunc("build/yui/yui.js", "_init", 314);
_yuitest_coverline("build/yui/yui.js", 315);
var filter, el,
            Y = this,
            G_ENV = YUI.Env,
            Env = Y.Env,
         ...
         * @type string
         */
        _yuitest_coverline("build/yui/yui.js", 326);
Y.version = VERSION;

        _yuitest_coverline("build/yui/yui.js", 328);
if (!Env) {
            _yuitest_coverline("build/yui/yui.js", 329);
Y.Env = {
                ...
                parseBasePath: function(src, pattern) {
                    _yuitest_coverfunc("build/yui/yui.js", "parseBasePath", 374);
_yuitest_coverline("build/yui/yui.js", 375);
var match = src.match(pattern),
                        path, filter;

                    _yuitest_coverline("build/yui/yui.js", 378);
if (match) {
                        _yuitest_coverline("build/yui/yui.js", 379);
path = RegExp.leftContext || src.slice(0, src.indexOf(match[0]));

                        // this is to set up the path to the loader.  The file
                        // filter for loader should match the yui include.
                        _yuitest_coverline("build/yui/yui.js", 383);
filter = match[3];

                        // extract correct path for mixed combo urls
                        // http://yuilibrary.com/projects/yui3/ticket/2528423
                        _yuitest_coverline("build/yui/yui.js", 387);
if (match[1]) {
                            _yuitest_coverline("build/yui/yui.js", 388);
path += '?' + match[1];
                        }
                        _yuitest_coverline("build/yui/yui.js", 390);
path = {
                            filter: filter,
                            path: path
                        }
                    }
                    _yuitest_coverline("build/yui/yui.js", 395);
return path;
                },
                getBase: G_ENV && G_ENV.getBase ||
                        function(pattern) {
                            _yuitest_coverfunc("build/yui/yui.js", "(anonymous 2)", 398);
_yuitest_coverline("build/yui/yui.js", 399);
var nodes = (doc && doc.getElementsByTagName('script')) || [],
                                path = Env.cdn, parsed,
                                i, len, src;

                            _yuitest_coverline("build/yui/yui.js", 403);
for (i = 0, len = nodes.length; i < len; ++i) {
                                _yuitest_coverline("build/yui/yui.js", 404);
src = nodes[i].src;
                                _yuitest_coverline("build/yui/yui.js", 405);
if (src) {
                                    _yuitest_coverline("build/yui/yui.js", 406);
parsed = Y.Env.parseBasePath(src, pattern);
                                    _yuitest_coverline("build/yui/yui.js", 407);
if (parsed) {
                                        _yuitest_coverline("build/yui/yui.js", 408);
filter = parsed.filter;
                                        _yuitest_coverline("build/yui/yui.js", 409);
path = parsed.path;
                                        _yuitest_coverline("build/yui/yui.js", 410);
break;
                                    }
                                }
                            }
...
return path;
            ...
            _yuitest_coverline("build/yui/yui.js", 421);
Env = Y.Env;

            _yuitest_coverline("build/yui/yui.js", 423);
Env._loaded[VERSION] = {};

            _yuitest_coverline("build/yui/yui.js", 425);
if (G_ENV && Y !== YUI) {
                _yuitest_coverline("build/yui/yui.js", 426);
Env._yidx = ++G_ENV._yidx;
                _yuitest_coverline("build/yui/yui.js", 427);
Env._guidp = ('yui_' + VERSION + '_' +
                             Env._yidx + '_' + time).replace(/\./g, '_').replace(/-/g, '_');
            } else {_yuitest_coverline("build/yui/yui.js", 429);
if (YUI._YUI) {

                _yuitest_coverline("build/yui/yui.js", 431);
G_ENV = YUI._YUI.Env;
                _yuitest_coverline("build/yui/yui.js", 432);
Env._yidx += G_ENV._yidx;
...
delete YUI._YUI;
            ...
            _yuitest_coverline("build/yui/yui.js", 444);
Y.id = Y.stamp(Y);
...
instances[Y.id] = Y;
        ...
        _yuitest_coverline("build/yui/yui.js", 449);
Y.constructor = YUI;

        // configuration defaults
        _yuitest_coverline("build/yui/yui.js", 452);
Y.config = Y.config || {
            bootstrap: true,
            cacheUse: true,
            debug: true,
        ...
        _yuitest_coverline("build/yui/yui.js", 465);
if (doc && !doc.getElementById(CSS_STAMP_EL)) {
            _yuitest_coverline("build/yui/yui.js", 466);
el = doc.createElement('div');
            _yuitest_coverline("build/yui/yui.js", 467);
el.innerHTML = '<div id="' + CSS_STAMP_EL + '" style="position: absolute !important; visibility: hidden !important"></div>';
            _yuitest_coverline("build/yui/yui.js", 468);
YUI.Env.cssStampEl = el.firstChild;
            _yuitest_coverline("build/yui/yui.js", 469);
if (doc.body) {
                _yuitest_coverline("build/yui/yui.js", 470);
doc.body.appendChild(YUI.Env.cssStampEl);
            } else {
                _yuitest_coverline("build/yui/yui.js", 472);
...
filter = (filter) ? '-' + filter : filter;
        _yuitest_coverline("build/yui/yui.js", 484);
Y.config.loaderPath = YUI.config.loaderPath || 'loader/loader' + filter + '.js';
     ...
     */
    _setup: function(o) {
        _yuitest_coverfunc("build/yui/yui.js", "_setup", 494);
...
var i, Y = this,
        ...
        _yuitest_coverline("build/yui/yui.js", 500);
for (i = 0; i < extras.length; i++) {
            _yuitest_coverline("build/yui/yui.js", 501);
if (mods[extras[i]]) {
                _yuitest_coverline("build/yui/yui.js", 502);
core.push(extras[i]);
            }
        }

        _yuitest_coverline("build/yui/yui.js", 506);
Y._attach(['yui-base']);
        _yuitest_coverline("build/yui/yui.js", 507);
Y._attach(core);

        _yuitest_coverline("build/yui/yui.js", 509);
if (Y.Loader) {
            _yuitest_coverline("build/yui/yui.js", 510);
getLoader(Y);
        }
    ...
    applyTo: function(id, method, args) {
        _yuitest_coverfunc("build/yui/yui.js", "applyTo", 525);
_yuitest_coverline("build/yui/yui.js", 526);
if (!(method in APPLY_TO_AUTH)) {
            _yuitest_coverline("build/yui/yui.js", 527);
this.log(method + ': applyTo not allowed', 'warn', 'yui');
            _yuitest_coverline("build/yui/yui.js", 528);
return null;
        }

        _yuitest_coverline("build/yui/yui.js", 531);
var instance = instances[id], nest, m, i;
        _yuitest_coverline("build/yui/yui.js", 532);
if (instance) {
            _yuitest_coverline("build/yui/yui.js", 533);
nest = method.split('.');
            _yuitest_coverline("build/yui/yui.js", 534);
m = instance;
            _yuitest_coverline("build/yui/yui.js", 535);
for (i = 0; i < nest.length; i = i + 1) {
                _yuitest_coverline("build/yui/yui.js", 536);
m = m[nest[i]];
                _yuitest_coverline("build/yui/yui.js", 537);
if (!m) {
                    _yuitest_coverline("build/yui/yui.js", 538);
...
return m && m.apply(instance, args);
        ...
        _yuitest_coverline("build/yui/yui.js", 544);
return null;
    },
...
*/
    add: function(name, fn, version, details) {
        _yuitest_coverfunc("build/yui/yui.js", "add", 582);
_yuitest_coverline("build/yui/yui.js", 583);
details = details || {};
        _yuitest_coverline("build/yui/yui.js", 584);
var env = YUI.Env,
            mod = {
                name: name,
                fn: fn,
        ...
        _yuitest_coverline("build/yui/yui.js", 596);
env.mods[name] = mod;
        _yuitest_coverline("build/yui/yui.js", 597);
versions[version] = versions[version] || {};
        _yuitest_coverline("build/yui/yui.js", 598);
versions[version][name] = mod;

        _yuitest_coverline("build/yui/yui.js", 600);
for (i in instances) {
            _yuitest_coverline("build/yui/yui.js", 601);
if (instances.hasOwnProperty(i)) {
                _yuitest_coverline("build/yui/yui.js", 602);
inst = instances[i];
                _yuitest_coverline("build/yui/yui.js", 603);
if (!applied[inst.id]) {
                    _yuitest_coverline("build/yui/yui.js", 604);
applied[inst.id] = true;
                    _yuitest_coverline("build/yui/yui.js", 605);
loader = inst.Env._loader;
                    _yuitest_coverline("build/yui/yui.js", 606);
if (loader) {
                        _yuitest_coverline("build/yui/yui.js", 607);
if (!loader.moduleInfo[name] || loader.moduleInfo[name].temp) {
                            _yuitest_coverline("build/yui/yui.js", 608);
loader.addModule(details, name);
        ...
        _yuitest_coverline("build/yui/yui.js", 615);
return this;
    },
    ...
    _attach: function(r, moot) {
        _yuitest_coverfunc("build/yui/yui.js", "_attach", 626);
...
var i, name, mod, details, req, use, after,
        ...
        _yuitest_coverline("build/yui/yui.js", 639);
for (i = 0; i < len; i++) {
            _yuitest_coverline("build/yui/yui.js", 640);
name = r[i];
            _yuitest_coverline("build/yui/yui.js", 641);
mod = mods[name];
            _yuitest_coverline("build/yui/yui.js", 642);
c.push(name);
            _yuitest_coverline("build/yui/yui.js", 643);
if (loader && loader.conditions[name]) {
                _yuitest_coverline("build/yui/yui.js", 644);
for (j in loader.conditions[name]) {
                    _yuitest_coverline("build/yui/yui.js", 645);
if (loader.conditions[name].hasOwnProperty(j)) {
                        _yuitest_coverline("build/yui/yui.js", 646);
def = loader.conditions[name][j];
                        _yuitest_coverline("build/yui/yui.js", 647);
go = def && ((def.ua && Y.UA[def.ua]) || (def.test && def.test(Y)));
                        _yuitest_coverline("build/yui/yui.js", 648);
if (go) {
                            _yuitest_coverline("build/yui/yui.js", 649);
c.push(def.name);
                        }
                    }
                }
...
r = c;
        _yuitest_coverline("build/yui/yui.js", 656);
len = r.length;

        _yuitest_coverline("build/yui/yui.js", 658);
for (i = 0; i < len; i++) {
            _yuitest_coverline("build/yui/yui.js", 659);
if (!done[r[i]]) {
                _yuitest_coverline("build/yui/yui.js", 660);
name = r[i];
                _yuitest_coverline("build/yui/yui.js", 661);
mod = mods[name];

                _yuitest_coverline("build/yui/yui.js", 663);
if (aliases && aliases[name] && !mod) {
                    _yuitest_coverline("build/yui/yui.js", 664);
Y._attach(aliases[name]);
                    _yuitest_coverline("build/yui/yui.js", 665);
continue;
                }
...
if ((name.indexOf('skin-') === -1) && (name.indexOf('css') === -1)) {
                            _yuitest_coverline("build/yui/yui.js", 678);
Y.Env._missed.push(name);
                            _yuitest_coverline("build/yui/yui.js", 679);
Y.Env._missed = Y.Array.dedupe(Y.Env._missed);
                            _yuitest_coverline("build/yui/yui.js", 680);
...
Y.message('Found: ' + name + ' (was reported as missing earlier)', 'warn', 'yui');
                            _yuitest_coverline("build/yui/yui.js", 690);
...
if (loader && cache && cache[name] && cache[name].temp) {
                        _yuitest_coverline("build/yui/yui.js", 699);
loader.getRequires(cache[name]);
                        _yuitest_coverline("build/yui/yui.js", 700);
req = [];
                        _yuitest_coverline("build/yui/yui.js", 701);
for (j in loader.moduleInfo[name].expanded_map) {
                            _yuitest_coverline("build/yui/yui.js", 702);
if (loader.moduleInfo[name].expanded_map.hasOwnProperty(j)) {
                                _yuitest_coverline("build/yui/yui.js", 703);
req.push(j);
                            }
                        }
...
Y._attach(req);
                    ...
                    _yuitest_coverline("build/yui/yui.js", 709);
details = mod.details;
                    _yuitest_coverline("build/yui/yui.js", 710);
req = details.requires;
                    _yuitest_coverline("build/yui/yui.js", 711);
use = details.use;
                    _yuitest_coverline("build/yui/yui.js", 712);
after = details.after;
                    //Force Intl load if there is a language (Loader logic) @todo fix this shit
                    _yuitest_coverline("build/yui/yui.js", 714);
if (details.lang) {
...
req.unshift('intl');
                    ...
                    _yuitest_coverline("build/yui/yui.js", 719);
if (req) {
                        _yuitest_coverline("build/yui/yui.js", 720);
for (j = 0; j < req.length; j++) {
                            _yuitest_coverline("build/yui/yui.js", 721);
if (!done[req[j]]) {
                                _yuitest_coverline("build/yui/yui.js", 722);
if (!Y._attach(req)) {
                                    _yuitest_coverline("build/yui/yui.js", 723);
return false;
                                }
                                _yuitest_coverline("build/yui/yui.js", 725);
break;
                            }
                        }
                    }
...
for (j = 0; j < after.length; j++) {
                            _yuitest_coverline("build/yui/yui.js", 732);
if (!done[after[j]]) {
                                _yuitest_coverline("build/yui/yui.js", 733);
if (!Y._attach(after, true)) {
                                    _yuitest_coverline("build/yui/yui.js", 734);
return false;
                                }
                                _yuitest_coverline("build/yui/yui.js", 736);
break;
                            }
                        }
                    }

                    _yuitest_coverline("build/yui/yui.js", 741);
if (mod.fn) {
...
mod.fn(Y, name);
                                ...
                                _yuitest_coverline("build/yui/yui.js", 745);
try {
                                    _yuitest_coverline("build/yui/yui.js", 746);
mod.fn(Y, name);
                                } catch (e) {
...
return false;
                    ...
                    _yuitest_coverline("build/yui/yui.js", 754);
if (use) {
                        _yuitest_coverline("build/yui/yui.js", 755);
for (j = 0; j < use.length; j++) {
                            _yuitest_coverline("build/yui/yui.js", 756);
if (!done[use[j]]) {
                                _yuitest_coverline("build/yui/yui.js", 757);
if (!Y._attach(use)) {
...
return true;
    ...
    */
    _delayCallback: function(cb, until) {
        ...
        _yuitest_coverfunc("build/yui/yui.js", "_delayCallback", 780);
...
until = (Y.Lang.isObject(until) ? until : { event: until });
        ...
        _yuitest_coverline("build/yui/yui.js", 787);
if (until.event === 'load') {
            _yuitest_coverline("build/yui/yui.js", 788);
mod.push('event-synthetic');
        }

        _yuitest_coverline("build/yui/yui.js", 791);
return function() {
            _yuitest_coverfunc("build/yui/yui.js", "(anonymous 3)", 791);
_yuitest_coverline("build/yui/yui.js", 792);
var args = arguments;
            _yuitest_coverline("build/yui/yui.js", 793);
Y._use(mod, function() {
                _yuitest_coverfunc("build/yui/yui.js", "(anonymous 4)", 793);
_yuitest_coverline("build/yui/yui.js", 794);
Y.on(until.event, function() {
                    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 5)", 794);
_yuitest_coverline("build/yui/yui.js", 795);
args[1].delayUntil = until.event;
                    _yuitest_coverline("build/yui/yui.js", 796);
cb.apply(Y, args);
                }, until.args);
            });
        };
     ...
     */
    use: function() {
        _yuitest_coverfunc("build/yui/yui.js", "use", 850);
_yuitest_coverline("build/yui/yui.js", 851);
var args = SLICE.call(arguments, 0),
        ...
        _yuitest_coverline("build/yui/yui.js", 861);
if (Y.Lang.isFunction(callback)) {
            _yuitest_coverline("build/yui/yui.js", 862);
args.pop();
            _yuitest_coverline("build/yui/yui.js", 863);
if (Y.config.delayUntil) {
                _yuitest_coverline("build/yui/yui.js", 864);
callback = Y._delayCallback(callback, Y.config.delayUntil);
            }
        } else {
            _yuitest_coverline("build/yui/yui.js", 867);
callback = null;
        }
        _yuitest_coverline("build/yui/yui.js", 869);
if (Y.Lang.isArray(args[0])) {
            _yuitest_coverline("build/yui/yui.js", 870);
args = args[0];
        }

        _yuitest_coverline("build/yui/yui.js", 873);
if (Y.config.cacheUse) {
            _yuitest_coverline("build/yui/yui.js", 874);
while ((name = args[i++])) {
                _yuitest_coverline("build/yui/yui.js", 875);
if (!Env._attached[name]) {
                    _yuitest_coverline("build/yui/yui.js", 876);
provisioned = false;
                    _yuitest_coverline("build/yui/yui.js", 877);
break;
                }
            }

            _yuitest_coverline("build/yui/yui.js", 881);
if (provisioned) {
                _yuitest_coverline("build/yui/yui.js", 882);
if (args.length) {
                }
                _yuitest_coverline("build/yui/yui.js", 884);
Y._notify(callback, ALREADY_DONE, args);
                _yuitest_coverline("build/yui/yui.js", 885);
return Y;
            }
        }

        _yuitest_coverline("build/yui/yui.js", 889);
if (Y._loading) {
            _yuitest_coverline("build/yui/yui.js", 890);
Y._useQueue = Y._useQueue || new Y.Queue();
            _yuitest_coverline("build/yui/yui.js", 891);
Y._useQueue.add([args, callback]);
        } else {
            _yuitest_coverline("build/yui/yui.js", 893);
Y._use(args, function(Y, response) {
                _yuitest_coverfunc("build/yui/yui.js", "(anonymous 6)", 893);
_yuitest_coverline("build/yui/yui.js", 894);
Y._notify(callback, response, args);
            });
        }

        _yuitest_coverline("build/yui/yui.js", 898);
return Y;
    },
    /**
    ...
    */
    _notify: function(callback, response, args) {
        _yuitest_coverfunc("build/yui/yui.js", "_notify", 908);
_yuitest_coverline("build/yui/yui.js", 909);
if (!response.success && this.config.loadErrorFn) {
            _yuitest_coverline("build/yui/yui.js", 910);
this.config.loadErrorFn.call(this, this, callback, response, args);
        } else {_yuitest_coverline("build/yui/yui.js", 911);
if (callback) {
            _yuitest_coverline("build/yui/yui.js", 912);
if (this.Env._missed && this.Env._missed.length) {
                _yuitest_coverline("build/yui/yui.js", 913);
response.msg = 'Missing modules: ' + this.Env._missed.join();
                _yuitest_coverline("build/yui/yui.js", 914);
response.success = false;
            }
            _yuitest_coverline("build/yui/yui.js", 916);
if (this.config.throwFail) {
                _yuitest_coverline("build/yui/yui.js", 917);
callback(this, response);
            } else {
                _yuitest_coverline("build/yui/yui.js", 919);
try {
                    _yuitest_coverline("build/yui/yui.js", 920);
callback(this, response);
                } catch (e) {
...
this.error('use callback error', e, args);
    ...
    */
    _use: function(args, callback) {
        ...
        _yuitest_coverfunc("build/yui/yui.js", "_use", 938);
_yuitest_coverline("build/yui/yui.js", 940);
if (!this.Array) {
            _yuitest_coverline("build/yui/yui.js", 941);
this._attach(['yui-base']);
        }

        _yuitest_coverline("build/yui/yui.js", 944);
var len, loader, handleBoot, handleRLS,
            ...
            process = function(names, skip) {
                ...
                _yuitest_coverfunc("build/yui/yui.js", "process", 961);
_yuitest_coverline("build/yui/yui.js", 963);
var i = 0, a = [], name, len, m, req, use;

                _yuitest_coverline("build/yui/yui.js", 965);
if (!names.length) {
...
len = names.length;
                    _yuitest_coverline("build/yui/yui.js", 971);
for (i = 0; i < len; i++) {
                        _yuitest_coverline("build/yui/yui.js", 972);
if (aliases[names[i]] && !mods[names[i]]) {
                            _yuitest_coverline("build/yui/yui.js", 973);
a = [].concat(a, aliases[names[i]]);
                        } else {
                            _yuitest_coverline("build/yui/yui.js", 975);
a.push(names[i]);
                        }
                    }
                    _yuitest_coverline("build/yui/yui.js", 978);
names = a;
                }
                
                _yuitest_coverline("build/yui/yui.js", 981);
len = names.length;
                
                _yuitest_coverline("build/yui/yui.js", 983);
for (i = 0; i < len; i++) {
                    _yuitest_coverline("build/yui/yui.js", 984);
name = names[i];
                    _yuitest_coverline("build/yui/yui.js", 985);
if (!skip) {
                        _yuitest_coverline("build/yui/yui.js", 986);
r.push(name);
                    }
...
m = mods[name];
                    _yuitest_coverline("build/yui/yui.js", 995);
req = null;
                    _yuitest_coverline("build/yui/yui.js", 996);
use = null;

                    _yuitest_coverline("build/yui/yui.js", 998);
if (m) {
                        _yuitest_coverline("build/yui/yui.js", 999);
used[name] = true;
                        _yuitest_coverline("build/yui/yui.js", 1000);
req = m.details.requires;
                        _yuitest_coverline("build/yui/yui.js", 1001);
use = m.details.use;
                    } else {
                        // CSS files don't register themselves, see if it has
                        // been loaded
                        _yuitest_coverline("build/yui/yui.js", 1005);
if (!G_ENV._loaded[VERSION][name]) {
                            _yuitest_coverline("build/yui/yui.js", 1006);
missing.push(name);
                        } else {
                            _yuitest_coverline("build/yui/yui.js", 1008);
...
if (req && req.length) {
                        _yuitest_coverline("build/yui/yui.js", 1014);
process(req);
                    }

                    // make sure we grab the submodule dependencies too
                    _yuitest_coverline("build/yui/yui.js", 1018);
if (use && use.length) {
...
process(use, 1);
            ...
            handleLoader = function(fromLoader) {
                _yuitest_coverfunc("build/yui/yui.js", "handleLoader", 1025);
_yuitest_coverline("build/yui/yui.js", 1026);
...
if (data) {
                    _yuitest_coverline("build/yui/yui.js", 1037);
origMissing = missing;
                    _yuitest_coverline("build/yui/yui.js", 1038);
missing = [];
                    _yuitest_coverline("build/yui/yui.js", 1039);
r = [];
                    _yuitest_coverline("build/yui/yui.js", 1040);
process(data);
                    _yuitest_coverline("build/yui/yui.js", 1041);
redo = missing.length;
                    _yuitest_coverline("build/yui/yui.js", 1042);
if (redo) {
                        _yuitest_coverline("build/yui/yui.js", 1043);
...
Y._loading = true;
                    _yuitest_coverline("build/yui/yui.js", 1052);
Y._use(missing, function() {
                        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 7)", 1052);
_yuitest_coverline("build/yui/yui.js", 1053);
if (Y._attach(data)) {
                            _yuitest_coverline("build/yui/yui.js", 1054);
...
if (data) {
                        _yuitest_coverline("build/yui/yui.js", 1059);
ret = Y._attach(data);
                    }
                    _yuitest_coverline("build/yui/yui.js", 1061);
if (ret) {
                        _yuitest_coverline("build/yui/yui.js", 1062);
Y._notify(callback, response, args);
                    }
                }

                _yuitest_coverline("build/yui/yui.js", 1066);
if (Y._useQueue && Y._useQueue.size() && !Y._loading) {
                    _yuitest_coverline("build/yui/yui.js", 1067);
Y._use.apply(Y, Y._useQueue.next());
        ...
        _yuitest_coverline("build/yui/yui.js", 1074);
if (firstArg === '*') {
            _yuitest_coverline("build/yui/yui.js", 1075);
args = [];
            _yuitest_coverline("build/yui/yui.js", 1076);
for (i in mods) {
                _yuitest_coverline("build/yui/yui.js", 1077);
if (mods.hasOwnProperty(i)) {
                    _yuitest_coverline("build/yui/yui.js", 1078);
args.push(i);
                }
            }
            _yuitest_coverline("build/yui/yui.js", 1081);
ret = Y._attach(args);
            _yuitest_coverline("build/yui/yui.js", 1082);
if (ret) {
                _yuitest_coverline("build/yui/yui.js", 1083);
handleLoader();
            }
            _yuitest_coverline("build/yui/yui.js", 1085);
return Y;
        }
...
if (boot && Y.Loader && args.length) {
            _yuitest_coverline("build/yui/yui.js", 1096);
loader = getLoader(Y);
            _yuitest_coverline("build/yui/yui.js", 1097);
loader.require(args);
            _yuitest_coverline("build/yui/yui.js", 1098);
loader.ignoreRegistered = true;
            _yuitest_coverline("build/yui/yui.js", 1099);
loader._boot = true;
...
loader._boot = false;
        ...
        _yuitest_coverline("build/yui/yui.js", 1105);
process(args);

        _yuitest_coverline("build/yui/yui.js", 1107);
len = missing.length;


        _yuitest_coverline("build/yui/yui.js", 1110);
if (len) {
...
if (boot && len && Y.Loader) {
            _yuitest_coverline("build/yui/yui.js", 1118);
Y._loading = true;
            _yuitest_coverline("build/yui/yui.js", 1119);
loader = getLoader(Y);
            _yuitest_coverline("build/yui/yui.js", 1120);
loader.onEnd = handleLoader;
            _yuitest_coverline("build/yui/yui.js", 1121);
loader.context = Y;
            _yuitest_coverline("build/yui/yui.js", 1122);
loader.data = args;
            _yuitest_coverline("build/yui/yui.js", 1123);
loader.ignoreRegistered = false;
...
loader.insert(null, (fetchCSS) ? null : 'js');
        ...
        } else {_yuitest_coverline("build/yui/yui.js", 1127);
if (boot && len && Y.Get && !Env.bootstrapped) {

            _yuitest_coverline("build/yui/yui.js", 1129);
Y._loading = true;

            _yuitest_coverline("build/yui/yui.js", 1131);
handleBoot = function() {
                _yuitest_coverfunc("build/yui/yui.js", "handleBoot", 1131);
_yuitest_coverline("build/yui/yui.js", 1132);
Y._loading = false;
                _yuitest_coverline("build/yui/yui.js", 1133);
queue.running = false;
                _yuitest_coverline("build/yui/yui.js", 1134);
Env.bootstrapped = true;
                _yuitest_coverline("build/yui/yui.js", 1135);
G_ENV._bootstrapping = false;
                _yuitest_coverline("build/yui/yui.js", 1136);
if (Y._attach(['loader'])) {
                    _yuitest_coverline("build/yui/yui.js", 1137);
Y._use(args, callback);
                }
            };

            _yuitest_coverline("build/yui/yui.js", 1141);
if (G_ENV._bootstrapping) {
                _yuitest_coverline("build/yui/yui.js", 1142);
queue.add(handleBoot);
            } else {
                _yuitest_coverline("build/yui/yui.js", 1144);
...
if (ret) {
                _yuitest_coverline("build/yui/yui.js", 1153);
handleLoader();
            }
        }}
...
return Y;
    ...
    **/
    namespace: function() {
        _yuitest_coverfunc("build/yui/yui.js", "namespace", 1194);
_yuitest_coverline("build/yui/yui.js", 1195);
var a = arguments, o, i = 0, j, d, arg;

        _yuitest_coverline("build/yui/yui.js", 1197);
for (; i < a.length; i++) {
            _yuitest_coverline("build/yui/yui.js", 1198);
o = this; //Reset base object per argument or it will get reused from the last
            _yuitest_coverline("build/yui/yui.js", 1199);
arg = a[i];
            _yuitest_coverline("build/yui/yui.js", 1200);
...
o[d[j]] = o[d[j]] || {};
                    _yuitest_coverline("build/yui/yui.js", 1204);
o = o[d[j]];
                }
            } else {
                _yuitest_coverline("build/yui/yui.js", 1207);
o[arg] = o[arg] || {};
                _yuitest_coverline("build/yui/yui.js", 1208);
o = o[arg]; //Reset base object to the new object so it's returned
            }
        }
        _yuitest_coverline("build/yui/yui.js", 1211);
return o;
    },
    ...
    dump: function (o) { _yuitest_coverfunc("build/yui/yui.js", "dump", 1218);
_yuitest_coverline("build/yui/yui.js", 1218);
return ''+o; },
    ...
    error: function(msg, e, src) {
        ...
        _yuitest_coverfunc("build/yui/yui.js", "error", 1233);
_yuitest_coverline("build/yui/yui.js", 1236);
var Y = this, ret;

        _yuitest_coverline("build/yui/yui.js", 1238);
if (Y.config.errorFn) {
            _yuitest_coverline("build/yui/yui.js", 1239);
ret = Y.config.errorFn.apply(Y, arguments);
        }

        _yuitest_coverline("build/yui/yui.js", 1242);
if (!ret) {
            _yuitest_coverline("build/yui/yui.js", 1243);
throw (e || new Error(msg));
        } else {
            _yuitest_coverline("build/yui/yui.js", 1245);
Y.message(msg, 'error', ''+src); // don't scrub this one
        }

        _yuitest_coverline("build/yui/yui.js", 1248);
return Y;
    },
     ...
     */
    guid: function(pre) {
        _yuitest_coverfunc("build/yui/yui.js", "guid", 1257);
...
return (pre) ? (pre + id) : id;
    ...
    stamp: function(o, readOnly) {
        _yuitest_coverfunc("build/yui/yui.js", "stamp", 1272);
_yuitest_coverline("build/yui/yui.js", 1273);
var uid;
        _yuitest_coverline("build/yui/yui.js", 1274);
if (!o) {
            _yuitest_coverline("build/yui/yui.js", 1275);
return o;
        }

        // IE generates its own unique ID for dom nodes
        // The uniqueID property of a document node returns a new ID
        _yuitest_coverline("build/yui/yui.js", 1280);
if (o.uniqueID && o.nodeType && o.nodeType !== 9) {
            _yuitest_coverline("build/yui/yui.js", 1281);
uid = o.uniqueID;
        } else {
            _yuitest_coverline("build/yui/yui.js", 1283);
uid = (typeof o === 'string') ? o : o._yuid;
        }

        _yuitest_coverline("build/yui/yui.js", 1286);
if (!uid) {
            _yuitest_coverline("build/yui/yui.js", 1287);
uid = this.guid();
            _yuitest_coverline("build/yui/yui.js", 1288);
if (!readOnly) {
                _yuitest_coverline("build/yui/yui.js", 1289);
try {
                    _yuitest_coverline("build/yui/yui.js", 1290);
o._yuid = uid;
                } catch (e) {
                    _yuitest_coverline("build/yui/yui.js", 1292);
uid = null;
                }
            }
        }
...
return uid;
     ...
     */
    destroy: function() {
        _yuitest_coverfunc("build/yui/yui.js", "destroy", 1304);
_yuitest_coverline("build/yui/yui.js", 1305);
var Y = this;
        _yuitest_coverline("build/yui/yui.js", 1306);
if (Y.Event) {
            _yuitest_coverline("build/yui/yui.js", 1307);
Y.Event._unload();
        }
        _yuitest_coverline("build/yui/yui.js", 1309);
delete instances[Y.id];
        _yuitest_coverline("build/yui/yui.js", 1310);
delete Y.Env;
        _yuitest_coverline("build/yui/yui.js", 1311);
delete Y.config;
    }
    ...
    _yuitest_coverline("build/yui/yui.js", 1325);
YUI.prototype = proto;

    // inheritance utilities are not available yet
    _yuitest_coverline("build/yui/yui.js", 1328);
for (prop in proto) {
        _yuitest_coverline("build/yui/yui.js", 1329);
if (proto.hasOwnProperty(prop)) {
            _yuitest_coverline("build/yui/yui.js", 1330);
YUI[prop] = proto[prop];
        }
    }
...
@example
    ...
    */
    _yuitest_coverline("build/yui/yui.js", 1366);
YUI.applyConfig = function(o) {
        _yuitest_coverfunc("build/yui/yui.js", "applyConfig", 1366);
_yuitest_coverline("build/yui/yui.js", 1367);
if (!o) {
            _yuitest_coverline("build/yui/yui.js", 1368);
return;
        }
        //If there is a GlobalConfig, apply it first to set the defaults
        _yuitest_coverline("build/yui/yui.js", 1371);
if (YUI.GlobalConfig) {
            _yuitest_coverline("build/yui/yui.js", 1372);
...
YUI._init();
    ...
    _yuitest_coverline("build/yui/yui.js", 1383);
if (hasWin) {
        // add a window load event at load time so we can capture
        // the case where it fires before dynamic loading is
        // complete.
        _yuitest_coverline("build/yui/yui.js", 1387);
add(window, 'load', handleLoad);
    } else {
        _yuitest_coverline("build/yui/yui.js", 1389);
handleLoad();
    }

    _yuitest_coverline("build/yui/yui.js", 1392);
YUI.Env.add = add;
    _yuitest_coverline("build/yui/yui.js", 1393);
YUI.Env.remove = remove;

    /*global exports*/
    // Support the CommonJS method for exporting our single global
    _yuitest_coverline("build/yui/yui.js", 1397);
...
*/
_yuitest_coverline("build/yui/yui.js", 1950);
...
_yuitest_coverfunc("build/yui/yui.js", "(anonymous 8)", 1950);
_yuitest_coverline("build/yui/yui.js", 1972);
var L = Y.Lang || (Y.Lang = {}),
...
@since 3.5.0
**/
_yuitest_coverline("build/yui/yui.js", 2020);
L._isNative = function (fn) {
    _yuitest_coverfunc("build/yui/yui.js", "_isNative", 2020);
_yuitest_coverline("build/yui/yui.js", 2021);
...
L.isArray = L._isNative(Array.isArray) ? Array.isArray : function (o) {
    _yuitest_coverfunc("build/yui/yui.js", "isArray", 2038);
_yuitest_coverline("build/yui/yui.js", 2039);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 2049);
L.isBoolean = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isBoolean", 2049);
_yuitest_coverline("build/yui/yui.js", 2050);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 2060);
L.isDate = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isDate", 2060);
_yuitest_coverline("build/yui/yui.js", 2061);
...
L.isFunction = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isFunction", 2088);
_yuitest_coverline("build/yui/yui.js", 2089);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 2099);
L.isNull = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isNull", 2099);
_yuitest_coverline("build/yui/yui.js", 2100);
return o === null;
};
 ...
 */
_yuitest_coverline("build/yui/yui.js", 2110);
L.isNumber = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isNumber", 2110);
_yuitest_coverline("build/yui/yui.js", 2111);
...
L.isObject = function(o, failfn) {
    _yuitest_coverfunc("build/yui/yui.js", "isObject", 2125);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 2138);
L.isString = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isString", 2138);
_yuitest_coverline("build/yui/yui.js", 2139);
...
L.isUndefined = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isUndefined", 2149);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 2162);
L.isValue = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isValue", 2162);
_yuitest_coverline("build/yui/yui.js", 2163);
var t = L.type(o);

    _yuitest_coverline("build/yui/yui.js", 2165);
switch (t) {
        case 'number':
            _yuitest_coverline("build/yui/yui.js", 2167);
return isFinite(o);

        case 'null': // fallthru
        case 'undefined':
            _yuitest_coverline("build/yui/yui.js", 2171);
return false;

        default:
            _yuitest_coverline("build/yui/yui.js", 2174);
return !!t;
    }
};
...
L.now = Date.now || function () {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 9)", 2186);
 ...
 * @since 3.2.0
 */
_yuitest_coverline("build/yui/yui.js", 2201);
L.sub = function(s, o) {
    _yuitest_coverfunc("build/yui/yui.js", "sub", 2201);
_yuitest_coverline("build/yui/yui.js", 2202);
return s.replace ? s.replace(SUBREGEX, function (match, key) {
        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 10)", 2202);
_yuitest_coverline("build/yui/yui.js", 2203);
...
L.trim = STRING_PROTO.trim ? function(s) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 11)", 2215);
_yuitest_coverline("build/yui/yui.js", 2216);
return s && s.trim ? s.trim() : s;
} : function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2217);
_yuitest_coverline("build/yui/yui.js", 2218);
try {
        _yuitest_coverline("build/yui/yui.js", 2219);
...
L.trimLeft = STRING_PROTO.trimLeft ? function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 12)", 2232);
_yuitest_coverline("build/yui/yui.js", 2233);
return s.trimLeft();
} : function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2234);
_yuitest_coverline("build/yui/yui.js", 2235);
return s.replace(/^\s+/, '');
};
 ...
 * @return {string} the trimmed string.
 */
_yuitest_coverline("build/yui/yui.js", 2245);
L.trimRight = STRING_PROTO.trimRight ? function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 13)", 2245);
_yuitest_coverline("build/yui/yui.js", 2246);
return s.trimRight();
} : function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2247);
_yuitest_coverline("build/yui/yui.js", 2248);
return s.replace(/\s+$/, '');
};
...
@static
**/
_yuitest_coverline("build/yui/yui.js", 2278);
L.type = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "type", 2278);
...
_yuitest_coverline("build/yui/yui.js", 2286);
var Lang   = Y.Lang,
...
function YArray(thing, startIndex, force) {
    _yuitest_coverfunc("build/yui/yui.js", "YArray", 2319);
_yuitest_coverline("build/yui/yui.js", 2320);
var len, result;

    _yuitest_coverline("build/yui/yui.js", 2322);
startIndex || (startIndex = 0);

    _yuitest_coverline("build/yui/yui.js", 2324);
if (force || YArray.test(thing)) {
        // IE throws when trying to slice HTMLElement collections.
        _yuitest_coverline("build/yui/yui.js", 2326);
try {
            _yuitest_coverline("build/yui/yui.js", 2327);
return Native.slice.call(thing, startIndex);
        } catch (ex) {
            _yuitest_coverline("build/yui/yui.js", 2329);
result = [];

            _yuitest_coverline("build/yui/yui.js", 2331);
for (len = thing.length; startIndex < len; ++startIndex) {
                _yuitest_coverline("build/yui/yui.js", 2332);
result.push(thing[startIndex]);
            }

            _yuitest_coverline("build/yui/yui.js", 2335);
return result;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 2339);
return [thing];
}

_yuitest_coverline("build/yui/yui.js", 2342);
Y.Array = YArray;
...
@since 3.4.0
**/
_yuitest_coverline("build/yui/yui.js", 2358);
YArray.dedupe = function (array) {
    _yuitest_coverfunc("build/yui/yui.js", "dedupe", 2358);
_yuitest_coverline("build/yui/yui.js", 2359);
var hash    = {},
        results = [],
        i, item, len;
...
for (i = 0, len = array.length; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2364);
item = array[i];

        _yuitest_coverline("build/yui/yui.js", 2366);
if (!hasOwn.call(hash, item)) {
            _yuitest_coverline("build/yui/yui.js", 2367);
hash[item] = 1;
            _yuitest_coverline("build/yui/yui.js", 2368);
results.push(item);
        }
    }

    _yuitest_coverline("build/yui/yui.js", 2372);
return results;
};
...
@static
**/
_yuitest_coverline("build/yui/yui.js", 2390);
YArray.each = YArray.forEach = Lang._isNative(Native.forEach) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 14)", 2390);
_yuitest_coverline("build/yui/yui.js", 2391);
Native.forEach.call(array || [], fn, thisObj || Y);
    _yuitest_coverline("build/yui/yui.js", 2392);
return Y;
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2393);
_yuitest_coverline("build/yui/yui.js", 2394);
for (var i = 0, len = (array && array.length) || 0; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2395);
if (i in array) {
...
fn.call(thisObj || Y, array[i], i, array);
    ...
    _yuitest_coverline("build/yui/yui.js", 2400);
return Y;
};
...
@static
**/
_yuitest_coverline("build/yui/yui.js", 2427);
YArray.hash = function (keys, values) {
    _yuitest_coverfunc("build/yui/yui.js", "hash", 2427);
_yuitest_coverline("build/yui/yui.js", 2428);
var hash = {},
        vlen = (values && values.length) || 0,
        i, len;

    _yuitest_coverline("build/yui/yui.js", 2432);
for (i = 0, len = keys.length; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2433);
if (i in keys) {
            _yuitest_coverline("build/yui/yui.js", 2434);
hash[keys[i]] = vlen > i && i in values ? values[i] : true;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 2438);
return hash;
};
...
YArray.indexOf = Lang._isNative(Native.indexOf) ? function (array, value, from) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 15)", 2455);
_yuitest_coverline("build/yui/yui.js", 2456);
return Native.indexOf.call(array, value, from);
} : function (array, value, from) {
    // http://es5.github.com/#x15.4.4.14
    _yuitest_coverfunc("build/yui/yui.js", "}", 2457);
_yuitest_coverline("build/yui/yui.js", 2459);
var len = array.length;

    _yuitest_coverline("build/yui/yui.js", 2461);
from = +from || 0;
    _yuitest_coverline("build/yui/yui.js", 2462);
from = (from > 0 || -1) * Math.floor(Math.abs(from));

    _yuitest_coverline("build/yui/yui.js", 2464);
if (from < 0) {
        _yuitest_coverline("build/yui/yui.js", 2465);
from += len;

        _yuitest_coverline("build/yui/yui.js", 2467);
if (from < 0) {
            _yuitest_coverline("build/yui/yui.js", 2468);
from = 0;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 2472);
for (; from < len; ++from) {
        _yuitest_coverline("build/yui/yui.js", 2473);
if (from in array && array[from] === value) {
            _yuitest_coverline("build/yui/yui.js", 2474);
return from;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 2478);
return -1;
};
...
@static
**/
_yuitest_coverline("build/yui/yui.js", 2500);
YArray.numericSort = function (a, b) {
    _yuitest_coverfunc("build/yui/yui.js", "numericSort", 2500);
_yuitest_coverline("build/yui/yui.js", 2501);
return a - b;
};
...
YArray.some = Lang._isNative(Native.some) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 16)", 2520);
_yuitest_coverline("build/yui/yui.js", 2521);
return Native.some.call(array, fn, thisObj);
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2522);
_yuitest_coverline("build/yui/yui.js", 2523);
for (var i = 0, len = array.length; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2524);
if (i in array && fn.call(thisObj, array[i], i, array)) {
            _yuitest_coverline("build/yui/yui.js", 2525);
return true;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 2529);
return false;
};
...
@static
**/
_yuitest_coverline("build/yui/yui.js", 2550);
YArray.test = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "test", 2550);
_yuitest_coverline("build/yui/yui.js", 2551);
var result = 0;

    _yuitest_coverline("build/yui/yui.js", 2553);
if (Lang.isArray(obj)) {
        _yuitest_coverline("build/yui/yui.js", 2554);
result = 1;
    } else {_yuitest_coverline("build/yui/yui.js", 2555);
if (Lang.isObject(obj)) {
        _yuitest_coverline("build/yui/yui.js", 2556);
try {
            // indexed, but no tagName (element) or alert (window),
            // or functions without apply/call (Safari
            // HTMLElementCollection bug).
            _yuitest_coverline("build/yui/yui.js", 2560);
if ('length' in obj && !obj.tagName && !obj.alert && !obj.apply) {
                _yuitest_coverline("build/yui/yui.js", 2561);
result = 2;
            }
        } catch (ex) {}
    }}

    _yuitest_coverline("build/yui/yui.js", 2566);
return result;
};
/**
 * The YUI module contains the components required for building the YUI
...
function Queue() {
    _yuitest_coverfunc("build/yui/yui.js", "Queue", 2584);
_yuitest_coverline("build/yui/yui.js", 2585);
this._init();
    _yuitest_coverline("build/yui/yui.js", 2586);
this.add.apply(this, arguments);
}

_yuitest_coverline("build/yui/yui.js", 2589);
Queue.prototype = {
    /**
    ...
    _init: function() {
         ...
         * @protected
         */
        _yuitest_coverfunc("build/yui/yui.js", "_init", 2596);
...
this._q = [];
     ...
     */
    next: function() {
        _yuitest_coverfunc("build/yui/yui.js", "next", 2613);
_yuitest_coverline("build/yui/yui.js", 2614);
return this._q.shift();
     ...
     */
    last: function() {
        _yuitest_coverfunc("build/yui/yui.js", "last", 2623);
_yuitest_coverline("build/yui/yui.js", 2624);
return this._q.pop();
    },
     ...
     */
    add: function() {
        _yuitest_coverfunc("build/yui/yui.js", "add", 2634);
_yuitest_coverline("build/yui/yui.js", 2635);
this._q.push.apply(this._q, arguments);

        _yuitest_coverline("build/yui/yui.js", 2637);
return this;
    },
     ...
     */
    size: function() {
        _yuitest_coverfunc("build/yui/yui.js", "size", 2646);
_yuitest_coverline("build/yui/yui.js", 2647);
return this._q.length;
    }
};

_yuitest_coverline("build/yui/yui.js", 2651);
Y.Queue = Queue;

_yuitest_coverline("build/yui/yui.js", 2653);
...
_yuitest_coverline("build/yui/yui.js", 2664);
...
@for YUI
**/
_yuitest_coverline("build/yui/yui.js", 2693);
Y.cached = function (source, cache, refetch) {
    _yuitest_coverfunc("build/yui/yui.js", "cached", 2693);
_yuitest_coverline("build/yui/yui.js", 2694);
cache || (cache = {});

    _yuitest_coverline("build/yui/yui.js", 2696);
return function (arg) {
        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 17)", 2696);
_yuitest_coverline("build/yui/yui.js", 2697);
var key = arguments.length > 1 ?
                Array.prototype.join.call(arguments, CACHED_DELIMITER) :
                String(arg);

        _yuitest_coverline("build/yui/yui.js", 2701);
if (!(key in cache) || (refetch && cache[key] == refetch)) {
            _yuitest_coverline("build/yui/yui.js", 2702);
cache[key] = source.apply(source, arguments);
        }

        _yuitest_coverline("build/yui/yui.js", 2705);
return cache[key];
    };
};
...
@since 3.5.0
**/
_yuitest_coverline("build/yui/yui.js", 2725);
Y.getLocation = function () {
    // It is safer to look this up every time because yui-base is attached to a
    // YUI instance before a user's config is applied; i.e. `Y.config.win` does
    // not point the correct window object when this file is loaded.
    _yuitest_coverfunc("build/yui/yui.js", "getLocation", 2725);
_yuitest_coverline("build/yui/yui.js", 2729);
var win = Y.config.win;
    ...
    _yuitest_coverline("build/yui/yui.js", 2735);
...
**/
_yuitest_coverline("build/yui/yui.js", 2750);
Y.merge = function () {
    _yuitest_coverfunc("build/yui/yui.js", "merge", 2750);
_yuitest_coverline("build/yui/yui.js", 2751);
var args   = arguments,
        i      = 0,
        len    = args.length,
        result = {};

    _yuitest_coverline("build/yui/yui.js", 2756);
for (; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2757);
Y.mix(result, args[i], true);
    }

    _yuitest_coverline("build/yui/yui.js", 2760);
return result;
};
...
**/
_yuitest_coverline("build/yui/yui.js", 2797);
Y.mix = function(receiver, supplier, overwrite, whitelist, mode, merge) {
    _yuitest_coverfunc("build/yui/yui.js", "mix", 2797);
_yuitest_coverline("build/yui/yui.js", 2798);
var alwaysOverwrite, exists, from, i, key, len, to;

    // If no supplier is given, we return the receiver. If no receiver is given,
    // we return Y. Returning Y doesn't make much sense to me, but it's
    // grandfathered in for backcompat reasons.
    _yuitest_coverline("build/yui/yui.js", 2803);
if (!receiver || !supplier) {
        _yuitest_coverline("build/yui/yui.js", 2804);
return receiver || Y;
    }

    _yuitest_coverline("build/yui/yui.js", 2807);
if (mode) {
        // In mode 2 (prototype to prototype and object to object), we recurse
        // once to do the proto to proto mix. The object to object mix will be
        // handled later on.
        _yuitest_coverline("build/yui/yui.js", 2811);
if (mode === 2) {
            _yuitest_coverline("build/yui/yui.js", 2812);
...
from = mode === 1 || mode === 3 ? supplier.prototype : supplier;
        _yuitest_coverline("build/yui/yui.js", 2819);
...
if (!from || !to) {
            _yuitest_coverline("build/yui/yui.js", 2825);
return receiver;
        }
    } else {
...
to   = receiver;
    ...
    _yuitest_coverline("build/yui/yui.js", 2834);
...
for (i = 0, len = whitelist.length; i < len; ++i) {
            _yuitest_coverline("build/yui/yui.js", 2838);
key = whitelist[i];
...
if (!hasOwn.call(from, key)) {
                _yuitest_coverline("build/yui/yui.js", 2846);
continue;
            }
            ...
            _yuitest_coverline("build/yui/yui.js", 2852);
exists = alwaysOverwrite ? false : key in to;

            _yuitest_coverline("build/yui/yui.js", 2854);
if (merge && exists && isObject(to[key], true)
                ...
                _yuitest_coverline("build/yui/yui.js", 2864);
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui/yui.js", 2865);
if (overwrite || !exists) {
                // We're not in merge mode, so we'll only copy the `from` value
                // to the `to` value if we're in overwrite mode or if the
                // current key doesn't exist on the `to` object.
                _yuitest_coverline("build/yui/yui.js", 2869);
to[key] = from[key];
            }}
        }
    } else {
        _yuitest_coverline("build/yui/yui.js", 2873);
for (key in from) {
            ...
            _yuitest_coverline("build/yui/yui.js", 2879);
if (!hasOwn.call(from, key)) {
                _yuitest_coverline("build/yui/yui.js", 2880);
continue;
            }
...
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui/yui.js", 2891);
if (overwrite || !exists) {
                _yuitest_coverline("build/yui/yui.js", 2892);
to[key] = from[key];
            }}
        }
        ...
        // the buggy properties as the whitelist.
        _yuitest_coverline("build/yui/yui.js", 2899);
if (Y.Object._hasEnumBug) {
            _yuitest_coverline("build/yui/yui.js", 2900);
...
_yuitest_coverline("build/yui/yui.js", 2920);
var Lang   = Y.Lang,
    hasOwn = Object.prototype.hasOwnProperty,
...
O = Y.Object = Lang._isNative(Object.create) ? function (obj) {
    ...
    // Object.create().
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 18)", 2936);
_yuitest_coverline("build/yui/yui.js", 2942);
return Object.create(obj);
} : (function () {
    // Reusable constructor function for the Object.create() shim.
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 19)", 2943);
_yuitest_coverline("build/yui/yui.js", 2945);
function F() {}

    // The actual shim.
    _yuitest_coverline("build/yui/yui.js", 2948);
return function (obj) {
        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 20)", 2948);
_yuitest_coverline("build/yui/yui.js", 2949);
F.prototype = obj;
        _yuitest_coverline("build/yui/yui.js", 2950);
return new F();
    };
}()),
...
owns = O.owns = function (obj, key) {
    _yuitest_coverfunc("build/yui/yui.js", "owns", 3011);
_yuitest_coverline("build/yui/yui.js", 3012);
...
O.keys = Lang._isNative(Object.keys) ? Object.keys : function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "keys", 3047);
_yuitest_coverline("build/yui/yui.js", 3048);
if (!Lang.isObject(obj)) {
        _yuitest_coverline("build/yui/yui.js", 3049);
throw new TypeError('Object.keys called on a non-object');
    }

    _yuitest_coverline("build/yui/yui.js", 3052);
var keys = [],
        i, key, len;

    _yuitest_coverline("build/yui/yui.js", 3055);
if (hasProtoEnumBug && typeof obj === 'function') {
        _yuitest_coverline("build/yui/yui.js", 3056);
for (key in obj) {
            _yuitest_coverline("build/yui/yui.js", 3057);
if (owns(obj, key) && key !== 'prototype') {
                _yuitest_coverline("build/yui/yui.js", 3058);
keys.push(key);
            }
        }
    } else {
        _yuitest_coverline("build/yui/yui.js", 3062);
for (key in obj) {
            _yuitest_coverline("build/yui/yui.js", 3063);
if (owns(obj, key)) {
                _yuitest_coverline("build/yui/yui.js", 3064);
keys.push(key);
            }
        }
    }

    _yuitest_coverline("build/yui/yui.js", 3069);
if (hasEnumBug) {
        _yuitest_coverline("build/yui/yui.js", 3070);
for (i = 0, len = forceEnum.length; i < len; ++i) {
            _yuitest_coverline("build/yui/yui.js", 3071);
key = forceEnum[i];

            _yuitest_coverline("build/yui/yui.js", 3073);
if (owns(obj, key)) {
                _yuitest_coverline("build/yui/yui.js", 3074);
keys.push(key);
            }
        }
    }

    _yuitest_coverline("build/yui/yui.js", 3079);
return keys;
};
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 3099);
O.values = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "values", 3099);
_yuitest_coverline("build/yui/yui.js", 3100);
var keys   = O.keys(obj),
        i      = 0,
        len    = keys.length,
        values = [];

    _yuitest_coverline("build/yui/yui.js", 3105);
for (; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 3106);
values.push(obj[keys[i]]);
    }

    _yuitest_coverline("build/yui/yui.js", 3109);
return values;
};
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 3120);
O.size = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "size", 3120);
_yuitest_coverline("build/yui/yui.js", 3121);
try {
        _yuitest_coverline("build/yui/yui.js", 3122);
return O.keys(obj).length;
    } catch (ex) {
        _yuitest_coverline("build/yui/yui.js", 3124);
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 3138);
O.hasValue = function (obj, value) {
    _yuitest_coverfunc("build/yui/yui.js", "hasValue", 3138);
_yuitest_coverline("build/yui/yui.js", 3139);
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 3162);
O.each = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui/yui.js", "each", 3162);
_yuitest_coverline("build/yui/yui.js", 3163);
var key;

    _yuitest_coverline("build/yui/yui.js", 3165);
for (key in obj) {
        _yuitest_coverline("build/yui/yui.js", 3166);
if (proto || owns(obj, key)) {
            _yuitest_coverline("build/yui/yui.js", 3167);
fn.call(thisObj || Y, obj[key], key, obj);
        }
    }

    _yuitest_coverline("build/yui/yui.js", 3171);
return Y;
};
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 3194);
O.some = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui/yui.js", "some", 3194);
_yuitest_coverline("build/yui/yui.js", 3195);
var key;

    _yuitest_coverline("build/yui/yui.js", 3197);
for (key in obj) {
        _yuitest_coverline("build/yui/yui.js", 3198);
if (proto || owns(obj, key)) {
            _yuitest_coverline("build/yui/yui.js", 3199);
if (fn.call(thisObj || Y, obj[key], key, obj)) {
                _yuitest_coverline("build/yui/yui.js", 3200);
return true;
            }
        }
    }

    _yuitest_coverline("build/yui/yui.js", 3205);
return false;
};
 ...
 */
_yuitest_coverline("build/yui/yui.js", 3221);
O.getValue = function(o, path) {
    _yuitest_coverfunc("build/yui/yui.js", "getValue", 3221);
_yuitest_coverline("build/yui/yui.js", 3222);
if (!Lang.isObject(o)) {
        _yuitest_coverline("build/yui/yui.js", 3223);
return UNDEFINED;
    }

    _yuitest_coverline("build/yui/yui.js", 3226);
var i,
        p = Y.Array(path),
        l = p.length;

    _yuitest_coverline("build/yui/yui.js", 3230);
for (i = 0; o !== UNDEFINED && i < l; i++) {
        _yuitest_coverline("build/yui/yui.js", 3231);
o = o[p[i]];
    }

    _yuitest_coverline("build/yui/yui.js", 3234);
return o;
};
 ...
 */
_yuitest_coverline("build/yui/yui.js", 3251);
O.setValue = function(o, path, val) {
    _yuitest_coverfunc("build/yui/yui.js", "setValue", 3251);
_yuitest_coverline("build/yui/yui.js", 3252);
var i,
        p = Y.Array(path),
        leafIdx = p.length - 1,
        ref = o;

    _yuitest_coverline("build/yui/yui.js", 3257);
if (leafIdx >= 0) {
        _yuitest_coverline("build/yui/yui.js", 3258);
for (i = 0; ref !== UNDEFINED && i < leafIdx; i++) {
            _yuitest_coverline("build/yui/yui.js", 3259);
ref = ref[p[i]];
        }

        _yuitest_coverline("build/yui/yui.js", 3262);
if (ref !== UNDEFINED) {
            _yuitest_coverline("build/yui/yui.js", 3263);
ref[p[i]] = val;
        } else {
            _yuitest_coverline("build/yui/yui.js", 3265);
return UNDEFINED;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 3269);
return o;
};
 ...
 * @since 3.2.0
 */
_yuitest_coverline("build/yui/yui.js", 3281);
O.isEmpty = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "isEmpty", 3281);
_yuitest_coverline("build/yui/yui.js", 3282);
...
*/
_yuitest_coverline("build/yui/yui.js", 3317);
YUI.Env.parseUA = function(subUA) {

    _yuitest_coverfunc("build/yui/yui.js", "parseUA", 3317);
_yuitest_coverline("build/yui/yui.js", 3319);
var numberify = function(s) {
            _yuitest_coverfunc("build/yui/yui.js", "numberify", 3319);
_yuitest_coverline("build/yui/yui.js", 3320);
var c = 0;
            _yuitest_coverline("build/yui/yui.js", 3321);
return parseFloat(s.replace(/\./g, function() {
                _yuitest_coverfunc("build/yui/yui.js", "(anonymous 22)", 3321);
...
return (c++ == 1) ? '' : '.';
    ...
    * @static
    */
    _yuitest_coverline("build/yui/yui.js", 3549);
o.userAgent = ua;


    _yuitest_coverline("build/yui/yui.js", 3552);
o.secure = href && (href.toLowerCase().indexOf('https') === 0);

    _yuitest_coverline("build/yui/yui.js", 3554);
if (ua) {

        _yuitest_coverline("build/yui/yui.js", 3556);
if ((/windows|win32/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3557);
o.os = 'windows';
        } else {_yuitest_coverline("build/yui/yui.js", 3558);
if ((/macintosh|mac_powerpc/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3559);
o.os = 'macintosh';
        } else {_yuitest_coverline("build/yui/yui.js", 3560);
if ((/android/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3561);
o.os = 'android';
        } else {_yuitest_coverline("build/yui/yui.js", 3562);
if ((/symbos/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3563);
o.os = 'symbos';
        } else {_yuitest_coverline("build/yui/yui.js", 3564);
if ((/linux/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3565);
o.os = 'linux';
        } else {_yuitest_coverline("build/yui/yui.js", 3566);
if ((/rhino/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3567);
o.os = 'rhino';
        }}}}}}

        // Modern KHTML browsers should qualify as Safari X-Grade
        _yuitest_coverline("build/yui/yui.js", 3571);
if ((/KHTML/).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3572);
o.webkit = 1;
        }
        _yuitest_coverline("build/yui/yui.js", 3574);
if ((/IEMobile|XBLWP7/).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3575);
o.mobile = 'windows';
        }
        _yuitest_coverline("build/yui/yui.js", 3577);
if ((/Fennec/).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3578);
o.mobile = 'gecko';
        }
        // Modern WebKit browsers are at least X-Grade
        _yuitest_coverline("build/yui/yui.js", 3581);
m = ua.match(/AppleWebKit\/([^\s]*)/);
        _yuitest_coverline("build/yui/yui.js", 3582);
if (m && m[1]) {
            _yuitest_coverline("build/yui/yui.js", 3583);
o.webkit = numberify(m[1]);
            _yuitest_coverline("build/yui/yui.js", 3584);
o.safari = o.webkit;
            
            _yuitest_coverline("build/yui/yui.js", 3586);
if (/PhantomJS/.test(ua)) {
                _yuitest_coverline("build/yui/yui.js", 3587);
m = ua.match(/PhantomJS\/([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 3588);
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 3589);
o.phantomjs = numberify(m[1]);
                }
            }

            // Mobile browser check
            _yuitest_coverline("build/yui/yui.js", 3594);
if (/ Mobile\//.test(ua) || (/iPad|iPod|iPhone/).test(ua)) {
                _yuitest_coverline("build/yui/yui.js", 3595);
o.mobile = 'Apple'; // iPhone or iPod Touch

                _yuitest_coverline("build/yui/yui.js", 3597);
m = ua.match(/OS ([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 3598);
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 3599);
m = numberify(m[1].replace('_', '.'));
                }
                _yuitest_coverline("build/yui/yui.js", 3601);
o.ios = m;
                _yuitest_coverline("build/yui/yui.js", 3602);
o.os = 'ios';
                _yuitest_coverline("build/yui/yui.js", 3603);
o.ipad = o.ipod = o.iphone = 0;

                _yuitest_coverline("build/yui/yui.js", 3605);
m = ua.match(/iPad|iPod|iPhone/);
                _yuitest_coverline("build/yui/yui.js", 3606);
if (m && m[0]) {
                    _yuitest_coverline("build/yui/yui.js", 3607);
o[m[0].toLowerCase()] = o.ios;
                }
            } else {
                _yuitest_coverline("build/yui/yui.js", 3610);
m = ua.match(/NokiaN[^\/]*|webOS\/\d\.\d/);
                _yuitest_coverline("build/yui/yui.js", 3611);
if (m) {
                    // Nokia N-series, webOS, ex: NokiaN95
                    _yuitest_coverline("build/yui/yui.js", 3613);
o.mobile = m[0];
                }
                _yuitest_coverline("build/yui/yui.js", 3615);
if (/webOS/.test(ua)) {
                    _yuitest_coverline("build/yui/yui.js", 3616);
o.mobile = 'WebOS';
                    _yuitest_coverline("build/yui/yui.js", 3617);
m = ua.match(/webOS\/([^\s]*);/);
                    _yuitest_coverline("build/yui/yui.js", 3618);
if (m && m[1]) {
                        _yuitest_coverline("build/yui/yui.js", 3619);
o.webos = numberify(m[1]);
                    }
                }
                _yuitest_coverline("build/yui/yui.js", 3622);
if (/ Android/.test(ua)) {
                    _yuitest_coverline("build/yui/yui.js", 3623);
if (/Mobile/.test(ua)) {
                        _yuitest_coverline("build/yui/yui.js", 3624);
o.mobile = 'Android';
                    }
                    _yuitest_coverline("build/yui/yui.js", 3626);
m = ua.match(/Android ([^\s]*);/);
                    _yuitest_coverline("build/yui/yui.js", 3627);
if (m && m[1]) {
                        _yuitest_coverline("build/yui/yui.js", 3628);
o.android = numberify(m[1]);
                    }

                }
                _yuitest_coverline("build/yui/yui.js", 3632);
if (/Silk/.test(ua)) {
                    _yuitest_coverline("build/yui/yui.js", 3633);
m = ua.match(/Silk\/([^\s]*)\)/);
                    _yuitest_coverline("build/yui/yui.js", 3634);
if (m && m[1]) {
                        _yuitest_coverline("build/yui/yui.js", 3635);
o.silk = numberify(m[1]);
                    }
                    _yuitest_coverline("build/yui/yui.js", 3637);
if (!o.android) {
                        _yuitest_coverline("build/yui/yui.js", 3638);
o.android = 2.34; //Hack for desktop mode in Kindle
                        _yuitest_coverline("build/yui/yui.js", 3639);
o.os = 'Android';
                    }
                    _yuitest_coverline("build/yui/yui.js", 3641);
if (/Accelerated=true/.test(ua)) {
                        _yuitest_coverline("build/yui/yui.js", 3642);
o.accel = true;
                    }
                }
            }

            _yuitest_coverline("build/yui/yui.js", 3647);
m = ua.match(/(Chrome|CrMo|CriOS)\/([^\s]*)/);
            _yuitest_coverline("build/yui/yui.js", 3648);
if (m && m[1] && m[2]) {
                _yuitest_coverline("build/yui/yui.js", 3649);
o.chrome = numberify(m[2]); // Chrome
                _yuitest_coverline("build/yui/yui.js", 3650);
o.safari = 0; //Reset safari back to 0
                _yuitest_coverline("build/yui/yui.js", 3651);
if (m[1] === 'CrMo') {
                    _yuitest_coverline("build/yui/yui.js", 3652);
o.mobile = 'chrome';
                }
            } else {
                _yuitest_coverline("build/yui/yui.js", 3655);
m = ua.match(/AdobeAIR\/([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 3656);
if (m) {
                    _yuitest_coverline("build/yui/yui.js", 3657);
o.air = m[0]; // Adobe AIR 1.0 or better
                }
            }
        }

        _yuitest_coverline("build/yui/yui.js", 3662);
if (!o.webkit) { // not webkit
// @todo check Opera/8.01 (J2ME/MIDP; Opera Mini/2.0.4509/1316; fi; U; ssr)
            _yuitest_coverline("build/yui/yui.js", 3664);
if (/Opera/.test(ua)) {
                _yuitest_coverline("build/yui/yui.js", 3665);
m = ua.match(/Opera[\s\/]([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 3666);
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 3667);
o.opera = numberify(m[1]);
                }
                _yuitest_coverline("build/yui/yui.js", 3669);
m = ua.match(/Version\/([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 3670);
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 3671);
o.opera = numberify(m[1]); // opera 10+
                }

                _yuitest_coverline("build/yui/yui.js", 3674);
if (/Opera Mobi/.test(ua)) {
                    _yuitest_coverline("build/yui/yui.js", 3675);
o.mobile = 'opera';
                    _yuitest_coverline("build/yui/yui.js", 3676);
m = ua.replace('Opera Mobi', '').match(/Opera ([^\s]*)/);
                    _yuitest_coverline("build/yui/yui.js", 3677);
if (m && m[1]) {
                        _yuitest_coverline("build/yui/yui.js", 3678);
o.opera = numberify(m[1]);
                    }
                }
                _yuitest_coverline("build/yui/yui.js", 3681);
m = ua.match(/Opera Mini[^;]*/);

                _yuitest_coverline("build/yui/yui.js", 3683);
if (m) {
                    _yuitest_coverline("build/yui/yui.js", 3684);
o.mobile = m[0]; // ex: Opera Mini/2.0.4509/1316
                }
            } else { // not opera or webkit
                _yuitest_coverline("build/yui/yui.js", 3687);
m = ua.match(/MSIE\s([^;]*)/);
                _yuitest_coverline("build/yui/yui.js", 3688);
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 3689);
o.ie = numberify(m[1]);
                } else { // not opera, webkit, or ie
                    _yuitest_coverline("build/yui/yui.js", 3691);
m = ua.match(/Gecko\/([^\s]*)/);
                    _yuitest_coverline("build/yui/yui.js", 3692);
if (m) {
                        _yuitest_coverline("build/yui/yui.js", 3693);
o.gecko = 1; // Gecko detected, look for revision
                        _yuitest_coverline("build/yui/yui.js", 3694);
m = ua.match(/rv:([^\s\)]*)/);
                        _yuitest_coverline("build/yui/yui.js", 3695);
if (m && m[1]) {
                            _yuitest_coverline("build/yui/yui.js", 3696);
o.gecko = numberify(m[1]);
    ...
    _yuitest_coverline("build/yui/yui.js", 3705);
if (!subUA) {

        _yuitest_coverline("build/yui/yui.js", 3707);
if (typeof process == 'object') {

            _yuitest_coverline("build/yui/yui.js", 3709);
if (process.versions && process.versions.node) {
                //NodeJS
                _yuitest_coverline("build/yui/yui.js", 3711);
o.os = process.platform;
                _yuitest_coverline("build/yui/yui.js", 3712);
o.nodejs = numberify(process.versions.node);
            }
        }

        _yuitest_coverline("build/yui/yui.js", 3716);
YUI.Env.UA = o;

    }

    _yuitest_coverline("build/yui/yui.js", 3720);
return o;
};


_yuitest_coverline("build/yui/yui.js", 3724);
...
@return -1 if _a_ is lower than _b_, 0 if they're equivalent, 1 if _a_ is
    higher than _b_.
**/
_yuitest_coverline("build/yui/yui.js", 3746);
Y.UA.compareVersions = function (a, b) {
    _yuitest_coverfunc("build/yui/yui.js", "compareVersions", 3746);
_yuitest_coverline("build/yui/yui.js", 3747);
var aPart, aParts, bPart, bParts, i, len;

    _yuitest_coverline("build/yui/yui.js", 3749);
if (a === b) {
        _yuitest_coverline("build/yui/yui.js", 3750);
return 0;
    }

    _yuitest_coverline("build/yui/yui.js", 3753);
aParts = (a + '').split('.');
    _yuitest_coverline("build/yui/yui.js", 3754);
bParts = (b + '').split('.');

    _yuitest_coverline("build/yui/yui.js", 3756);
for (i = 0, len = Math.max(aParts.length, bParts.length); i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 3757);
aPart = parseInt(aParts[i], 10);
        _yuitest_coverline("build/yui/yui.js", 3758);
bPart = parseInt(bParts[i], 10);

        _yuitest_coverline("build/yui/yui.js", 3760);
isNaN(aPart) && (aPart = 0);
        _yuitest_coverline("build/yui/yui.js", 3761);
isNaN(bPart) && (bPart = 0);

        _yuitest_coverline("build/yui/yui.js", 3763);
if (aPart < bPart) {
            _yuitest_coverline("build/yui/yui.js", 3764);
return -1;
        }

        _yuitest_coverline("build/yui/yui.js", 3767);
if (aPart > bPart) {
            _yuitest_coverline("build/yui/yui.js", 3768);
return 1;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 3772);
return 0;
};
_yuitest_coverline("build/yui/yui.js", 3774);
YUI.Env.aliases = {
...
}, '3.7.0pr1', {"use": ["yui-base", "get", "features", "intl-base", "yui-log", "yui-later", "loader-base", "loader-rollup", "loader-yui3"]});
